...
import w0, { createContext as Jl, forwardRef as b0, useReducer as Zl, useState as wt, useEffect as ae, useRef as nr, useContext as Yl, useMemo as Ta } from "react";
import A0 from "react-dom";
import { Transition as E0, Dialog as v0, TransitionChild as Ku, DialogPanel as x0 } from "@headlessui/react";
import * as I0 from "@oasisprotocol/sapphire-paratime";
import { pbkdf2Sync as N0 } from "pbkdf2";
import { CBOR as jf } from "cbor-redux";
import * as qr from "asn1js";
import O0 from "mitt";
import { ProviderRpcError as Wf } from "viem";
import { parseAbi as zf } from "abitype";
import { ethers as Ra } from "ethers";
import B0 from "react-qr-code";
var k0 = Object.defineProperty, Qf = (n) => {
  throw TypeError(n);
}, S0 = (n, t, e) => t in n ? k0(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e, S = (n, t, e) => S0(n, typeof t != "symbol" ? t + "" : t, e), Xl = (n, t, e) => t.has(n) || Qf("Cannot " + e), f = (n, t, e) => (Xl(n, t, "read from private field"), e ? e.call(n) : t.get(n)), C = (n, t, e) => t.has(n) ? Qf("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(n) : t.set(n, e), A = (n, t, e, r) => (Xl(n, t, "write to private field"), t.set(n, e), e), F = (n, t, e) => (Xl(n, t, "access private method"), e), Ca = (n, t, e, r) => ({
  set _(s) {
    A(n, t, s);
  },
  get _() {
...
var qf = { exports: {} }, Pt = qf.exports = {}, Ye, Xe;
function Jc() {
...
var On = [], zs = !1, Mr, sa = -1;
function C0() {
  !zs || !Mr || (zs = !1, Mr.length ? On = Mr.concat(On) : sa = -1, On.length && Jf());
}
function Jf() {
  if (!zs) {
    var n = Kf(C0);
    zs = !0;
    for (var t = On.length; t; ) {
      for (Mr = On, On = []; ++sa < t; )
        Mr && Mr[sa].run();
      sa = -1, t = On.length;
    }
...
Pt.nextTick = function(n) {
  var t = new Array(arguments.length - 1);
  if (arguments.length > 1)
    for (var e = 1; e < arguments.length; e++)
      t[e - 1] = arguments[e];
  On.push(new Zf(n, t)), On.length === 1 && !zs && Kf(Jf);
};
function Zf(n, t) {
...
Pt.once = Tn;
Pt.off = Tn;
Pt.removeListener = Tn;
Pt.removeAllListeners = Tn;
Pt.emit = Tn;
Pt.prependListener = Tn;
Pt.prependOnceListener = Tn;
Pt.listeners = function(n) {
  return [];
};
Pt.binding = function(n) {
...
var P0 = qf.exports;
const U0 = /* @__PURE__ */ T0(P0);
var Ii = {}, Ai = A0;
if (U0.env.NODE_ENV === "production")
...
function q(n, t, e) {
  for (let r in t) {
    let s = t[r];
    const i = e ? e[r] : null;
    i && D0(s, i, r), Object.defineProperty(n, r, { enumerable: !0, value: s, writable: !1 });
  }
}
function Fs(n) {
  if (n == null)
...
function It(n, t, e) {
  let r = n;
  {
    ...
    i.push(`code=${t}`), i.push(`version=${L0}`), i.length && (n += " (" + i.join(", ") + ")");
  }
  let s;
  switch (t) {
...
function Xf(n, t, e) {
  ...
  O(!1, "invalid BytesLike value", t || "value", n);
}
function tt(n, t) {
  return Xf(n, t, !1);
}
...
function Kr(n) {
  return gt(n, !0) ? (n.length - 2) / 2 : tt(n).length;
}
function Nt(n, t, e) {
  const r = tt(n);
...
const Qa = BigInt(0), _e = BigInt(1), Ms = 9007199254740991;
function Pa(n, t) {
  const e = qa(n, "value"), r = BigInt(et(t, "width"));
...
function ru(n, t) {
  let e = z(n, "value");
  const r = BigInt(et(t, "width")), s = _e << r - _e;
  if (e < Qa) {
...
function Hr(n, t) {
  const e = qa(n, "value"), r = BigInt(et(t, "bits"));
  return e & (_e << r) - _e;
}
function z(n, t) {
  switch (typeof n) {
    case "bigint":
      return n;
    case "number":
      return O(Number.isInteger(n), "underflow", t || "value", n), O(n >= -Ms && n <= Ms, "overflow", t || "value", n), BigInt(n);
    case "string":
      try {
        if (n === "")
        ...
        O(!1, `invalid BigNumberish string: ${e.message}`, t || "value", n);
      }
  }
  O(!1, "invalid BigNumberish value", t || "value", n);
}
function qa(n, t) {
  const e = z(n, t);
...
function et(n, t) {
  switch (typeof n) {
    case "bigint":
      return O(n >= -Ms && n <= Ms, "overflow", t || "value", n), Number(n);
    case "number":
      return O(Number.isInteger(n), "underflow", t || "value", n), O(n >= -Ms && n <= Ms, "overflow", t || "value", n), n;
    case "string":
      try {
        if (n === "")
          throw new Error("empty string");
        return et(BigInt(n), t);
      } catch (e) {
        O(!1, `invalid numeric string: ${e.message}`, t || "value", n);
      }
  }
  O(!1, "invalid numeric value", t || "value", n);
}
function F0(n) {
  return et(ti(n));
}
...
function G0(n, t, e, r, s) {
  O(!1, `invalid codepoint at offset ${t}; ${n}`, "bytes", e);
}
function nd(n, t, e, r, s) {
...
function V0(n, t, e, r, s) {
  return n === "OVERLONG" ? (O(typeof s == "number", "invalid bad code point for replacement", "badCodepoint", s), r.push(s), 0) : (r.push(65533), nd(n, t, e));
}
...
function Ve(n, t) {
  O(typeof n == "string", "invalid string value", "str", n);
  let e = [];
  for (let r = 0; r < n.length; r++) {
    ...
    if (s < 128)
      ...
      O(r < n.length && (i & 64512) === 56320, "invalid surrogate pair", "str", n);
...
function rd(n) {
  async function t(e, r) {
    ...
    const o = new AbortController(), c = setTimeout(() => {
      i = It("request timeout", "TIMEOUT"), o.abort();
    }, e.timeout);
    r && r.addListener(() => {
      i = It("request cancelled", "CANCELLED"), o.abort();
    });
    const a = {
      method: e.method,
...
const z0 = 12, Q0 = 250;
let th = rd();
const q0 = new RegExp("^data:([^;:]*)?(;base64)?,(.*)$", "i"), K0 = new RegExp("^ipfs://(ipfs/)?(.*)$", "i");
let mc = !1;
...
const La = {
  data: sd,
  ipfs: id("https://gateway.ipfs.io/ipfs/")
}, od = /* @__PURE__ */ new WeakMap();
var ys, pr;
class J0 {
  constructor(t) {
    C(this, ys), C(this, pr), A(this, ys, []), A(this, pr, !1), od.set(t, () => {
      if (!f(this, pr)) {
        A(this, pr, !0);
...
var Oi, Bi, qe, Wn, ki, Si, _t, we, zn, ms, ws, bs, mn, en, gr, _s, Ti;
const Z0 = class Yc {
  /**
   ...
   */
  constructor(t) {
    C(this, _s), C(this, Oi), C(this, Bi), C(this, qe), C(this, Wn), C(this, ki), C(this, Si), C(this, _t), C(this, we), C(this, zn), C(this, ms), C(this, ws), C(this, bs), C(this, mn), C(this, en), C(this, gr), A(this, Si, String(t)), A(this, Oi, !1), A(this, Bi, !0), A(this, qe, {}), A(this, Wn, ""), A(this, ki, 3e5), A(this, en, {
      slotInterval: Q0,
      maxAttempts: z0
    }), A(this, gr, null);
  }
  ...
  set body(t) {
    if (t == null)
      A(this, _t, void 0), A(this, we, void 0);
    else if (typeof t == "string")
      A(this, _t, Ve(t)), A(this, we, "text/plain");
    else if (t instanceof Uint8Array)
      A(this, _t, t), A(this, we, "application/octet-stream");
    else if (typeof t == "object")
      A(this, _t, Ve(JSON.stringify(t))), A(this, we, "application/json");
    else
  ...
  get headers() {
    ...
    return f(this, zn) && (t.authorization = `Basic ${_0(Ve(f(this, zn)))}`), this.allowGzip && (t["accept-encoding"] = "gzip"), t["content-type"] == null && f(this, we) && (t["content-type"] = f(this, we)), this.body && (t["content-length"] = String(this.body.length)), t;
  }
  /**
   ...
   */
  setCredentials(t, e) {
    O(!t.match(/:/), "invalid basic authentication username", "username", "[REDACTED]"), A(this, zn, `${t}:${e}`);
  }
  /**
  ...
  set timeout(t) {
    O(t >= 0, "timeout must be non-zero", "timeout", t), A(this, ki, t);
  }
  /**
   ...
   */
  send() {
    return D(f(this, mn) == null, "request already sent", "UNSUPPORTED_OPERATION", { operation: "fetchRequest.send" }), A(this, mn, new J0(this)), F(this, _s, Ti).call(this, 0, cd() + this.timeout, 0, this, new ei(0, "", {}, null, this));
  }
  /**
  ...
  redirect(t) {
    ...
    const s = new Yc(t);
    return s.method = "GET", s.allowGzip = this.allowGzip, s.timeout = this.timeout, A(s, qe, Object.assign({}, f(this, qe))), f(this, _t) && A(s, _t, new Uint8Array(f(this, _t))), A(s, we, f(this, we)), s;
  }
  /**
...
Oi = /* @__PURE__ */ new WeakMap(), Bi = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), Wn = /* @__PURE__ */ new WeakMap(), ki = /* @__PURE__ */ new WeakMap(), Si = /* @__PURE__ */ new WeakMap(), _t = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), zn = /* @__PURE__ */ new WeakMap(), ms = /* @__PURE__ */ new WeakMap(), ws = /* @__PURE__ */ new WeakMap(), bs = /* @__PURE__ */ new WeakMap(), mn = /* @__PURE__ */ new WeakMap(), en = /* @__PURE__ */ new WeakMap(), gr = /* @__PURE__ */ new WeakMap(), _s = /* @__PURE__ */ new WeakSet(), Ti = async function(n, t, e, r, s) {
  var i, o, c;
  if (n >= f(this, en).maxAttempts)
    return s.makeServerError("exceeded maximum retry limit");
  D(cd() <= t, "timeout", "TIMEOUT", {
...
let ns = Z0;
var ia, oa, aa, be, Ri, As;
const Y0 = class ad {
  constructor(t, e, r, s, i) {
    C(this, ia), C(this, oa), C(this, aa), C(this, be), C(this, Ri), C(this, As), A(this, ia, t), A(this, oa, e), A(this, aa, Object.keys(r).reduce((o, c) => (o[c.toLowerCase()] = String(r[c]), o), {})), A(this, be, s == null ? null : new Uint8Array(s)), A(this, Ri, i || null), A(this, As, { message: "" });
  }
  toString() {
    return `<FetchResponse status=${this.statusCode} body=${f(this, be) ? W(f(this, be)) : "null"}>`;
  }
  /**
   ...
   */
  get body() {
    return f(this, be) == null ? null : new Uint8Array(f(this, be));
  }
  /**
  ...
  get bodyText() {
    try {
      return f(this, be) == null ? "" : Ua(f(this, be));
    } catch {
  ...
  makeServerError(t, e) {
    ...
    const s = new ad(599, r, this.headers, this.body, f(this, Ri) || void 0);
  ...
  throwThrottleError(t, e) {
    e == null ? e = -1 : O(Number.isInteger(e) && e >= 0, "invalid stall timeout", "stall", e);
...
ia = /* @__PURE__ */ new WeakMap(), oa = /* @__PURE__ */ new WeakMap(), aa = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), Ri = /* @__PURE__ */ new WeakMap(), As = /* @__PURE__ */ new WeakMap();
let ei = Y0;
function cd() {
...
const ey = BigInt(-1), Pe = BigInt(0), Gs = BigInt(1), ny = BigInt(5), Es = {};
let Qs = "0000";
for (; Qs.length < 80; )
  Qs += Qs;
function dr(n) {
...
function Ci(n, t, e) {
  ...
  if (t.signed) {
    ...
    D(e == null || n >= -s && n < s, "overflow", "NUMERIC_FAULT", {
      ...
      fault: "overflow",
      value: n
    }), n > Pe ? n = Pa(Hr(n, r), r) : n = -Pa(Hr(-n, r), r);
  } else {
    const s = Gs << r;
...
function wc(n) {
  ...
  if (typeof n == "string") {
    if (n !== "fixed") if (n === "ufixed")
      ...
      O(i, "invalid fixed format", "format", n), t = i[1] !== "u", e = parseInt(i[2]), r = parseInt(i[3]);
    }
  } else if (n) {
    const i = n, o = (c, a, l) => i[c] == null ? l : (O(typeof i[c] === a, "invalid fixed format (" + c + " not " + a + ")", "format." + c, i[c]), i[c]);
    t = o("signed", "boolean", t), e = o("width", "number", e), r = o("decimals", "number", r);
  }
  O(e % 8 === 0, "invalid FixedNumber width (not byte aligned)", "format.width", e), O(r <= 80, "invalid FixedNumber decimals (too large)", "format.decimals", r);
...
var tn, pt, re, bt, Sr, wn, Xc, tl, el, nl;
const ld = class vs {
   ...
   */
  constructor(t, e, r) {
    C(this, bt), S(this, "format"), C(this, tn), C(this, pt), C(this, re), S(this, "_value"), Do(t, Es, "FixedNumber"), A(this, pt, e), A(this, tn, r);
    const s = ry(e, r.decimals);
    q(this, { format: r.name, _value: s }), A(this, re, dr(r.decimals));
  }
  /**
   ...
   */
  addUnsafe(t) {
    return F(this, bt, Xc).call(this, t);
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%this%% added
   ...
   */
  add(t) {
    return F(this, bt, Xc).call(this, t, "add");
  }
  /**
   ...
   */
  subUnsafe(t) {
    return F(this, bt, tl).call(this, t);
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%other%% subtracted
   ...
   */
  sub(t) {
    return F(this, bt, tl).call(this, t, "sub");
  }
  /**
   ...
   */
  mulUnsafe(t) {
    return F(this, bt, el).call(this, t);
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%this%% multiplied
   ...
   */
  mul(t) {
    return F(this, bt, el).call(this, t, "mul");
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%this%% multiplied
   *  by %%other%%. A [[NumericFaultError]] is thrown if overflow
   ...
   */
  mulSignal(t) {
    F(this, bt, Sr).call(this, t);
    const e = f(this, pt) * f(t, pt);
    return D(e % f(this, re) === Pe, "precision lost during signalling mul", "NUMERIC_FAULT", {
      operation: "mulSignal",
      fault: "underflow",
      value: this
    }), F(this, bt, wn).call(this, e / f(this, re), "mulSignal");
  }
  /**
   ...
   */
  divUnsafe(t) {
    return F(this, bt, nl).call(this, t);
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%this%% divided
   *  by %%other%%, ignoring underflow (precision loss). A
   ...
   */
  div(t) {
    return F(this, bt, nl).call(this, t, "div");
  }
  /**
   *  Returns a new [[FixedNumber]] with the result of %%this%% divided
   ...
   */
  divSignal(t) {
    D(f(t, pt) !== Pe, "division by zero", "NUMERIC_FAULT", {
      operation: "div",
      fault: "divide-by-zero",
      value: this
    }), F(this, bt, Sr).call(this, t);
    const e = f(this, pt) * f(this, re);
    return D(e % f(t, pt) === Pe, "precision lost during signalling div", "NUMERIC_FAULT", {
      operation: "divSignal",
      fault: "underflow",
      value: this
    }), F(this, bt, wn).call(this, e / f(t, pt), "divSignal");
  }
  /**
  ...
  cmp(t) {
    ...
    return s > 0 ? r *= dr(s) : s < 0 && (e *= dr(-s)), e < r ? -1 : e > r ? 1 : 0;
  }
  /**
  ...
  floor() {
    let t = f(this, pt);
    return f(this, pt) < Pe && (t -= f(this, re) - Gs), t = f(this, pt) / f(this, re) * f(this, re), F(this, bt, wn).call(this, t, "floor");
  }
  /**
  ...
  ceiling() {
    let t = f(this, pt);
    return f(this, pt) > Pe && (t += f(this, re) - Gs), t = f(this, pt) / f(this, re) * f(this, re), F(this, bt, wn).call(this, t, "ceiling");
  }
  /**
  ...
  round(t) {
    if (t == null && (t = 0), t >= this.decimals)
      return this;
    const e = this.decimals - t, r = ny * dr(e - 1);
    let s = this.value + r;
    const i = dr(e);
  ...
  static fromValue(t, e, r) {
    const s = e == null ? 0 : et(e), i = wc(r);
    let o = z(t, "value");
    const c = s - i.decimals;
    if (c > 0) {
      const a = dr(c);
      D(o % a === Pe, "value loses precision for format", "NUMERIC_FAULT", {
        operation: "fromValue",
        fault: "underflow",
        value: t
      }), o /= a;
  ...
  static fromString(t, e) {
    ...
    O(r && r[2].length + r[3].length > 0, "invalid FixedNumber string value", "value", t);
    const s = wc(e);
    let i = r[2] || "0", o = r[3] || "";
...
tn = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakMap(), bt = /* @__PURE__ */ new WeakSet(), Sr = function(n) {
  O(this.format === n.format, "incompatible format; use fixedNumber.toFormat", "other", n);
}, wn = function(n, t) {
  return n = Ci(n, f(this, tn), t), new ld(Es, n, f(this, tn));
}, Xc = function(n, t) {
  return F(this, bt, Sr).call(this, n), F(this, bt, wn).call(this, f(this, pt) + f(n, pt), t);
}, tl = function(n, t) {
  return F(this, bt, Sr).call(this, n), F(this, bt, wn).call(this, f(this, pt) - f(n, pt), t);
}, el = function(n, t) {
  return F(this, bt, Sr).call(this, n), F(this, bt, wn).call(this, f(this, pt) * f(n, pt) / f(this, re), t);
}, nl = function(n, t) {
  return D(f(n, pt) !== Pe, "division by zero", "NUMERIC_FAULT", {
    operation: "div",
    fault: "divide-by-zero",
    value: this
  }), F(this, bt, Sr).call(this, n), F(this, bt, wn).call(this, f(this, pt) * f(this, re) / f(n, pt), t);
};
let sy = ld;
function iy(n) {
  let t = n.toString(16);
...
function ud(n, t) {
  ...
  return { consumed: 1, result: iy(n[t]) };
}
function Ka(n) {
  const t = tt(n, "data"), e = ud(t, 0);
  return O(e.consumed === t.length, "unexpected junk after rlp payload", "data", n), e.result;
}
function rh(n) {
  const t = [];
  for (; n; )
...
function ih(n, t) {
  let e = 18;
  if (typeof t == "string") {
    const r = oy.indexOf(t);
    O(r >= 0, "invalid unit", "unit", t), e = 3 * r;
  } else t != null && (e = et(t, "unit"));
  return sy.fromValue(n, e, { decimals: e, width: 512 }).toString();
}
const Xt = 32, rl = new Uint8Array(Xt), ay = ["then"], Zo = {}, fd = /* @__PURE__ */ new WeakMap();
function Tr(n) {
  return fd.get(n);
}
function oh(n, t) {
...
var Pi;
const cy = class Ui extends Array {
  /**
   *  @private
   */
  constructor(...t) {
...
function ah(n) {
  let t = Lt(n);
  return D(t.length <= Xt, "value out-of-bounds", "BUFFER_OVERRUN", { buffer: t, length: Xt, offset: t.length }), t.length !== Xt && (t = Yt(xt([rl.slice(t.length % Xt), t]))), t;
}
class Rn {
  constructor(t, e, r, s) {
...
class il {
  constructor() {
    C(this, Li), C(this, rr), C(this, sr), A(this, rr, []), A(this, sr, 0);
  }
  get data() {
    return xt(f(this, rr));
  }
  ...
  writeBytes(t) {
    let e = Yt(t);
    const r = e.length % Xt;
    return r && (e = Yt(xt([e, rl.slice(r)]))), F(this, Li, ca).call(this, e);
  }
  ...
  writeUpdatableValue() {
    const t = f(this, rr).length;
    return f(this, rr).push(rl), A(this, sr, f(this, sr) + Xt), (e) => {
      f(this, rr)[t] = ah(e);
    };
  }
}
rr = /* @__PURE__ */ new WeakMap(), sr = /* @__PURE__ */ new WeakMap(), Li = /* @__PURE__ */ new WeakSet(), ca = function(n) {
  return f(this, rr).push(n), A(this, sr, f(this, sr) + n.length), n.length;
};
var de, pe, Rr, qs, _r, yo, ol, dd;
const ly = class pd {
  constructor(t, e, r) {
    C(this, yo), S(this, "allowLoose"), C(this, de), C(this, pe), C(this, Rr), C(this, qs), C(this, _r), q(this, { allowLoose: !!e }), A(this, de, Yt(t)), A(this, Rr, 0), A(this, qs, null), A(this, _r, r ?? 1024), A(this, pe, 0);
  }
  get data() {
    return W(f(this, de));
  }
  get dataLength() {
    return f(this, de).length;
  }
  get consumed() {
    return f(this, pe);
  }
  get bytes() {
    return new Uint8Array(f(this, de));
  }
  // Create a sub-reader with the same underlying data, but offset
  subReader(t) {
    const e = new pd(f(this, de).slice(f(this, pe) + t), this.allowLoose, f(this, _r));
    return A(e, qs, this), e;
  }
  // Read bytes
  readBytes(t, e) {
    let r = F(this, yo, dd).call(this, 0, t, !!e);
    return F(this, yo, ol).call(this, t), A(this, pe, f(this, pe) + r.length), r.slice(0, t);
  }
  ...
  readIndex() {
    return F0(this.readBytes(Xt));
  }
};
de = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), Rr = /* @__PURE__ */ new WeakMap(), qs = /* @__PURE__ */ new WeakMap(), _r = /* @__PURE__ */ new WeakMap(), yo = /* @__PURE__ */ new WeakSet(), ol = function(n) {
  var t;
  if (f(this, qs))
  ...
  return f(this, pe) + r > f(this, de).length && (this.allowLoose && e && f(this, pe) + t <= f(this, de).length ? r = t : D(!1, "data out-of-bounds", "BUFFER_OVERRUN", {
    buffer: Yt(f(this, de)),
    length: f(this, de).length,
    offset: f(this, pe) + r
  })), f(this, de).slice(f(this, pe), f(this, pe) + r);
};
let uy = ly;
...
const yd = (n) => n instanceof Uint8Array, fy = (n) => new Uint32Array(n.buffer, n.byteOffset, Math.floor(n.byteLength / 4)), Ac = (n) => new DataView(n.buffer, n.byteOffset, n.byteLength), je = (n, t) => n << 32 - t | n >>> t, dy = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!dy)
...
function Ja(n) {
  if (typeof n == "string" && (n = py(n)), !yd(n))
...
let md = class extends iu {
  constructor(n, t) {
    super(), this.finished = !1, this.destroyed = !1, hy(n);
    const e = Ja(t);
...
const wd = (n, t, e) => new md(n, t).update(e).digest();
wd.create = (n, t) => new md(n, t);
function my(n, t, e, r) {
...
class bd extends iu {
  ...
  digestInto(t) {
    ni(this), gd(t, this), this.finished = !0;
    ...
    for (let u = o; u < s; u++)
      e[u] = 0;
    my(r, s - 8, BigInt(this.length * 8), i), this.process(r, 0);
...
const wy = (n, t, e) => n & t ^ ~n & e, by = (n, t, e) => n & t ^ n & e ^ t & e, Ay = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
let Ey = class extends bd {
  ...
  process(n, t) {
    ...
    for (let h = 0; h < 64; h++) {
      const u = je(o, 6) ^ je(o, 11) ^ je(o, 25), p = l + u + wy(o, c, a) + Ay[h] + Un[h] | 0, b = (je(e, 2) ^ je(e, 13) ^ je(e, 22)) + by(e, r, s) | 0;
...
const Ad = /* @__PURE__ */ ou(() => new Ey()), Yo = /* @__PURE__ */ BigInt(2 ** 32 - 1), al = /* @__PURE__ */ BigInt(32);
function Ed(n, t = !1) {
...
function vd(n, t = !1) {
  ...
  for (let s = 0; s < n.length; s++) {
    const { h: i, l: o } = Ed(n[s], t);
    [e[s], r[s]] = [i, o];
  }
  return [e, r];
}
const vy = (n, t) => BigInt(n >>> 0) << al | BigInt(t >>> 0), xy = (n, t, e) => n >>> e, Iy = (n, t, e) => n << 32 - e | t >>> e, Ny = (n, t, e) => n >>> e | t << 32 - e, Oy = (n, t, e) => n << 32 - e | t >>> e, By = (n, t, e) => n << 64 - e | t >>> e - 32, ky = (n, t, e) => n >>> e - 32 | t << 64 - e, Sy = (n, t) => t, Ty = (n, t) => n, xd = (n, t, e) => n << e | t >>> 32 - e, Id = (n, t, e) => t << e | n >>> 32 - e, Nd = (n, t, e) => t << e - 32 | n >>> 64 - e, Od = (n, t, e) => n << e - 32 | t >>> 64 - e;
function Ry(n, t, e, r) {
  const s = (t >>> 0) + (r >>> 0);
  return { h: n + e + (s / 2 ** 32 | 0) | 0, l: s | 0 };
}
const Cy = (n, t, e) => (n >>> 0) + (t >>> 0) + (e >>> 0), Py = (n, t, e, r) => t + e + r + (n / 2 ** 32 | 0) | 0, Uy = (n, t, e, r) => (n >>> 0) + (t >>> 0) + (e >>> 0) + (r >>> 0), Ly = (n, t, e, r, s) => t + e + r + s + (n / 2 ** 32 | 0) | 0, Dy = (n, t, e, r, s) => (n >>> 0) + (t >>> 0) + (e >>> 0) + (r >>> 0) + (s >>> 0), Fy = (n, t, e, r, s, i) => t + e + r + s + i + (n / 2 ** 32 | 0) | 0, Y = {
  fromBig: Ed,
  split: vd,
  toBig: vy,
  shrSH: xy,
...
class _y extends bd {
  ...
  process(t, e) {
    ...
    for (let v = 16; v < 80; v++) {
      const T = Ln[v - 15] | 0, k = Dn[v - 15] | 0, x = Y.rotrSH(T, k, 1) ^ Y.rotrSH(T, k, 8) ^ Y.shrSH(T, k, 7), N = Y.rotrSL(T, k, 1) ^ Y.rotrSL(T, k, 8) ^ Y.shrSL(T, k, 7), B = Ln[v - 2] | 0, _ = Dn[v - 2] | 0, U = Y.rotrSH(B, _, 19) ^ Y.rotrBH(B, _, 61) ^ Y.shrSH(B, _, 6), P = Y.rotrSL(B, _, 19) ^ Y.rotrBL(B, _, 61) ^ Y.shrSL(B, _, 6), V = Y.add4L(N, P, Dn[v - 7], Dn[v - 16]), $ = Y.add4H(V, x, U, Ln[v - 7], Ln[v - 16]);
      Ln[v] = $ | 0, Dn[v] = V | 0;
    }
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: a, Dh: l, Dl: h, Eh: u, El: p, Fh: b, Fl: y, Gh: d, Gl: g, Hh: w, Hl: I } = this;
    for (let v = 0; v < 80; v++) {
      const T = Y.rotrSH(u, p, 14) ^ Y.rotrSH(u, p, 18) ^ Y.rotrBH(u, p, 41), k = Y.rotrSL(u, p, 14) ^ Y.rotrSL(u, p, 18) ^ Y.rotrBL(u, p, 41), x = u & b ^ ~u & d, N = p & y ^ ~p & g, B = Y.add5L(I, k, N, Hy[v], Dn[v]), _ = Y.add5H(B, w, T, x, My[v], Ln[v]), U = B | 0, P = Y.rotrSH(r, s, 28) ^ Y.rotrBH(r, s, 34) ^ Y.rotrBH(r, s, 39), V = Y.rotrSL(r, s, 28) ^ Y.rotrBL(r, s, 34) ^ Y.rotrBL(r, s, 39), $ = r & i ^ r & c ^ i & c, nt = s & o ^ s & a ^ o & a;
      w = d | 0, I = g | 0, d = b | 0, g = y | 0, b = u | 0, y = p | 0, { h: u, l: p } = Y.add(l | 0, h | 0, _ | 0, U | 0), l = c | 0, h = a | 0, c = i | 0, a = o | 0, i = r | 0, o = s | 0;
      const m = Y.add3L(U, V, nt);
      r = Y.add3H(m, _, P, $), s = m | 0;
    }
    ({ h: r, l: s } = Y.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = Y.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: c, l: a } = Y.add(this.Ch | 0, this.Cl | 0, c | 0, a | 0), { h: l, l: h } = Y.add(this.Dh | 0, this.Dl | 0, l | 0, h | 0), { h: u, l: p } = Y.add(this.Eh | 0, this.El | 0, u | 0, p | 0), { h: b, l: y } = Y.add(this.Fh | 0, this.Fl | 0, b | 0, y | 0), { h: d, l: g } = Y.add(this.Gh | 0, this.Gl | 0, d | 0, g | 0), { h: w, l: I } = Y.add(this.Hh | 0, this.Hl | 0, w | 0, I | 0), this.set(r, s, i, o, c, a, l, h, u, p, b, y, d, g, w, I);
  }
  roundClean() {
    Ln.fill(0), Dn.fill(0);
  }
...
function $y(n) {
  ...
  O(!1, "invalid hashing algorithm name", "algorithm", n);
}
const [Bd, kd, Sd] = [[], [], []], jy = /* @__PURE__ */ BigInt(0), vi = /* @__PURE__ */ BigInt(1), Wy = /* @__PURE__ */ BigInt(2), zy = /* @__PURE__ */ BigInt(7), Qy = /* @__PURE__ */ BigInt(256), qy = /* @__PURE__ */ BigInt(113);
for (let n = 0, t = vi, e = 1, r = 0; n < 24; n++) {
  [e, r] = [r, (2 * e + 3 * r) % 5], Bd.push(2 * (5 * r + e)), kd.push((n + 1) * (n + 2) / 2 % 64);
  let s = jy;
  for (let i = 0; i < 7; i++)
    t = (t << vi ^ (t >> zy) * qy) % Qy, t & Wy && (s ^= vi << (vi << /* @__PURE__ */ BigInt(i)) - vi);
  Sd.push(s);
}
const [Ky, Jy] = /* @__PURE__ */ vd(Sd, !0), uh = (n, t, e) => e > 32 ? Nd(n, t, e) : xd(n, t, e), hh = (n, t, e) => e > 32 ? Od(n, t, e) : Id(n, t, e);
function Zy(n, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    let s = n[2], i = n[3];
    for (let o = 0; o < 24; o++) {
      const c = kd[o], a = uh(s, i, c), l = hh(s, i, c), h = Bd[o];
...
let Yy = class Td extends iu {
  ...
  constructor(t, e, r, s = !1, i = 24) {
    ...
    this.state = new Uint8Array(200), this.state32 = fy(this.state);
  }
  keccak() {
  ...
  _cloneInto(t) {
    ...
    return t || (t = new Td(e, r, s, o, i)), t.state32.set(this.state32), t.pos = this.pos, t.posOut = this.posOut, t.finished = this.finished, t.rounds = i, t.suffix = r, t.outputLen = s, t.enableXOF = o, t.destroyed = this.destroyed, t;
  }
};
const Xy = (n, t, e) => ou(() => new Yy(t, n, e)), tm = /* @__PURE__ */ Xy(1, 136, 256 / 8);
let Rd = !1;
const Cd = function(n) {
  return tm(n);
};
...
Object.freeze(Ot);
const Ud = function(n) {
  return $y("sha256").update(n).digest();
};
let Ld = Ud, Dd = !1;
function hr(n) {
  const t = tt(n, "data");
...
const Fd = BigInt(0), Za = BigInt(1), em = BigInt(2), Ya = (n) => n instanceof Uint8Array, nm = /* @__PURE__ */ Array.from({ length: 256 }, (n, t) => t.toString(16).padStart(2, "0"));
function ri(n) {
  if (!Ya(n))
    throw new Error("Uint8Array expected");
  let t = "";
...
const cm = (n, t, e) => n | (e ? Za : Fd) << BigInt(t), uu = (n) => (em << BigInt(n - 1)) - Za, Ec = (n) => new Uint8Array(n), fh = (n) => Uint8Array.from(n);
function Hd(n, t, e) {
...
const um = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  numberToVarBytesBE: rm,
  utf8ToBytes: im,
  validateObject: Fo
}, Symbol.toStringTag, { value: "Module" }));
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ft = BigInt(0), kt = BigInt(1), Cr = BigInt(2), hm = BigInt(3), cl = BigInt(4), dh = BigInt(5), ph = BigInt(8);
BigInt(9);
BigInt(16);
function ie(n, t) {
  const e = n % t;
...
function dm(n) {
  const t = (n - kt) / Cr;
  let e, r, s;
  for (e = n - kt, r = 0; e % Cr === Ft; e /= Cr, r++)
    ;
  for (s = Cr; s < n && fm(s, t, n) !== n - kt; s++)
    ;
  if (r === 1) {
    const o = (n + kt) / cl;
    return function(c, a) {
...
function ym(n) {
  const t = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, e = gm.reduce((r, s) => (r[s] = "function", r), t);
  return Fo(n, e);
}
function mm(n, t, e) {
  if (e < Ft)
...
function bm(n, t, e = !1, r = {}) {
  if (n <= Ft)
    throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: s, nByteLength: i } = _d(n, t);
  if (i > 2048)
    throw new Error("Field lengths over 2048 bytes are not supported");
  const o = pm(n), c = Object.freeze({
    ORDER: n,
    BITS: s,
    BYTES: i,
    MASK: uu(s),
...
function Am(n, t, e = !1) {
  const r = n.length, s = Gd(t), i = Vd(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error(`expected ${i}-1024 bytes of input, got ${r}`);
  const o = e ? Jr(n) : cu(n), c = ie(o, t - kt) + kt;
  return e ? lu(c, s) : ii(c, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Em = BigInt(0), vc = BigInt(1);
function vm(n, t) {
  const e = (s, i) => {
    const o = i.negate();
    return s ? o : i;
...
const { bytesToNumberBE: Im, hexToBytes: Nm } = um, Gr = {
  ...
  _parseInt(n) {
    ...
    return { d: Im(r), l: n.subarray(e + 2) };
  },
  toSig(n) {
    const { Err: t } = Gr, e = typeof n == "string" ? Nm(n) : n;
...
}, bn = BigInt(0), Ee = BigInt(1);
BigInt(2);
const gh = BigInt(3);
BigInt(4);
function Om(n) {
  const t = xm(n), { Fp: e } = t, r = t.toBytes || ((y, d, g) => {
    const w = d.toAffine();
    return Oo(Uint8Array.from([4]), e.toBytes(w.x), e.toBytes(w.y));
  }), s = t.fromBytes || ((y) => {
  ...
  function a(y) {
    ...
    let v;
    try {
      v = typeof y == "bigint" ? y : Jr(Ue("private key", y, g));
    } catch {
  ...
  class u {
    ...
    double() {
      ...
      let k = e.ZERO, x = e.ZERO, N = e.ZERO, B = e.mul(I, I), _ = e.mul(v, v), U = e.mul(T, T), P = e.mul(I, v);
      return P = e.add(P, P), N = e.mul(I, T), N = e.add(N, N), k = e.mul(d, N), x = e.mul(w, U), x = e.add(k, x), k = e.sub(_, x), x = e.add(_, x), x = e.mul(k, x), k = e.mul(P, k), N = e.mul(w, N), U = e.mul(d, U), P = e.sub(B, U), P = e.mul(d, P), P = e.add(P, N), N = e.add(B, B), B = e.add(N, B), B = e.add(B, U), B = e.mul(B, P), x = e.add(x, B), U = e.mul(v, T), U = e.add(U, U), B = e.mul(U, P), k = e.sub(k, B), N = e.mul(U, _), N = e.add(N, N), N = e.add(N, N), new u(k, x, N);
    }
    ...
    add(d) {
      ...
      let x = e.ZERO, N = e.ZERO, B = e.ZERO;
      const _ = t.a, U = e.mul(t.b, gh);
      let P = e.mul(g, v), V = e.mul(w, T), $ = e.mul(I, k), nt = e.add(g, w), m = e.add(v, T);
      nt = e.mul(nt, m), m = e.add(P, V), nt = e.sub(nt, m), m = e.add(g, I);
      let E = e.add(v, k);
      return m = e.mul(m, E), E = e.add(P, $), m = e.sub(m, E), E = e.add(w, I), x = e.add(T, k), E = e.mul(E, x), x = e.add(V, $), E = e.sub(E, x), B = e.mul(_, m), x = e.mul(U, $), B = e.add(x, B), x = e.sub(V, B), B = e.add(V, B), N = e.mul(x, B), V = e.add(P, P), V = e.add(V, P), $ = e.mul(_, $), m = e.mul(U, m), V = e.add(V, $), $ = e.sub(P, $), $ = e.mul(_, $), m = e.add(m, $), P = e.mul(V, m), N = e.add(N, P), P = e.mul(E, m), x = e.mul(nt, x), x = e.sub(x, P), P = e.mul(nt, V), B = e.mul(E, B), B = e.add(B, P), new u(x, N, B);
    }
    subtract(d) {
    ...
    multiplyUnsafe(d) {
      ...
      let { k1neg: I, k1: v, k2neg: T, k2: k } = w.splitScalar(d), x = g, N = g, B = this;
      for (; v > bn || k > bn; )
        v & Ee && (x = x.add(B)), k & Ee && (N = N.add(B)), B = B.double(), v >>= Ee, k >>= Ee;
    ...
    multiply(d) {
      ...
      if (v) {
        ...
        let { p: B, f: _ } = this.wNAF(k), { p: U, f: P } = this.wNAF(N);
        B = b.constTimeNegate(T, B), U = b.constTimeNegate(x, U), U = new u(e.mul(U.px, v.beta), U.py, U.pz), w = B.add(U), I = _.add(P);
      } else {
    ...
    multiplyAndAddUnsafe(d, g, w) {
      const I = u.BASE, v = (k, x) => x === bn || x === Ee || !k.equals(I) ? k.multiplyUnsafe(x) : k.multiply(x), T = v(this, g).add(v(d, w));
  ...
  const p = t.nBitLength, b = vm(u, t.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: t,
    ProjectivePoint: u,
...
function km(n) {
  const t = Bm(n), { Fp: e, n: r } = t, s = e.BYTES + 1, i = 2 * e.BYTES + 1;
  function o(m) {
  ...
  const { ProjectivePoint: l, normPrivateKeyToScalar: h, weierstrassEquation: u, isWithinCurveOrder: p } = Om({
    ...t,
    toBytes(m, E, R) {
      const M = E.toAffine(), H = e.toBytes(M.x), G = Oo;
  ...
  class w {
    ...
    static fromDER(E) {
      const { r: R, s: M } = Gr.toSig(Ue("DER", E));
      return new w(R, M);
    }
    assertValidity() {
      if (!p(this.r))
    ...
    recoverPublicKey(E) {
      ...
      const K = H & 1 ? "03" : "02", Z = l.fromHex(K + b(Q)), rt = a(Q), ht = c(-G * rt), At = c(M * rt), ot = l.BASE.multiplyAndAddUnsafe(Z, ht, At);
      if (!ot)
  ...
  function U(m, E, R = P) {
    ...
    const Z = N(m), rt = h(E), ht = [_(rt), _(Z)];
    if (K != null) {
    ...
    function Ht(lt) {
      ...
      if (!p(yt))
        return;
      const dt = a(yt), at = l.BASE.multiply(yt).toAffine(), Et = c(at.x);
      if (Et === bn)
        return;
      const Ut = c(dt * c(ot + Et * rt));
      if (Ut === bn)
        return;
      let Be = (at.x === Et ? 0 : 2) | Number(at.y & Ee), ke = Ut;
      return G && y(Ut) && (ke = d(Ut), Be ^= 1), new w(Et, ke, Be);
    }
    return { seed: At, k2sig: Ht };
  }
  const P = { lowS: t.lowS, prehash: !1 }, V = { lowS: t.lowS, prehash: !1 };
  function $(m, E, R = P) {
    const { seed: M, k2sig: H } = U(m, E, R), G = t;
    return Hd(G.hash.outputLen, G.nByteLength, G.hmac)(M, H);
  }
  l.BASE._setWindowSize(8);
  function nt(m, E, R, M = V) {
    var H;
    const G = m;
    ...
    if (Q && Z.hasHighS())
      return !1;
    K && (E = t.hash(E));
    const { r: ht, s: At } = Z, ot = N(E), Ht = a(At), lt = c(ot * Ht), yt = c(ht * Ht), dt = (H = l.BASE.multiplyAndAddUnsafe(rt, lt, yt)) == null ? void 0 : H.toAffine();
    return dt ? c(dt.x) === ht : !1;
  }
  return {
    CURVE: t,
    getPublicKey: v,
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const jd = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), yh = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), Rm = BigInt(1), ul = BigInt(2), mh = (n, t) => (n + t / ul) / t;
function Cm(n) {
  const t = jd, e = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), a = BigInt(88), l = n * n * n % t, h = l * l * n % t, u = ye(h, e, t) * h % t, p = ye(u, e, t) * h % t, b = ye(p, ul, t) * l % t, y = ye(b, s, t) * b % t, d = ye(y, i, t) * y % t, g = ye(d, c, t) * d % t, w = ye(g, a, t) * g % t, I = ye(w, c, t) * d % t, v = ye(I, e, t) * h % t, T = ye(v, o, t) * y % t, k = ye(T, r, t) * l % t, x = ye(k, ul, t);
  if (!hl.eql(hl.sqr(x), n))
    throw new Error("Cannot find square root");
  return x;
}
const hl = bm(jd, void 0, void 0, { sqrt: Cm }), Qn = Tm({
  a: BigInt(0),
  b: BigInt(7),
  Fp: hl,
  n: yh,
  ...
  endo: {
    ...
    splitScalar: (n) => {
      const t = yh, e = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), r = -Rm * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), s = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), i = e, o = BigInt("0x100000000000000000000000000000000"), c = mh(i * n, t), a = mh(-r * n, t);
...
const Pm = class Ke {
  ...
  set r(t) {
    O(Kr(t) === 32, "invalid r", "value", t), A(this, Di, W(t));
  }
  /**
  ...
  set s(t) {
    O(Kr(t) === 32, "invalid s", "value", t);
    const e = W(t);
    O(parseInt(e.substring(0, 3)) < 8, "non-canonical s", "value", e), A(this, Fi, e);
  }
  /**
  ...
  set v(t) {
    const e = et(t, "value");
    O(e === 27 || e === 28, "invalid v", "v", t), A(this, Mi, e);
  }
  /**
  ...
  static getChainId(t) {
    const e = z(t, "v");
    return e == Eh || e == vh ? wh : (O(e >= Xo, "invalid EIP-155 v", "v", t), (e - Xo) / Ah);
  }
  /**
  ...
  static getNormalizedV(t) {
    const e = z(t);
    return e === wh || e === Eh ? 27 : e === bh || e === vh ? 28 : (O(e >= Xo, "invalid v", "v", t), e & bh ? 27 : 28);
  }
  /**
  ...
  static from(t) {
    ...
    e((tt(i)[0] & 128) == 0, "non-canonical s");
    const { networkV: o, v: c } = function(l, h, u) {
      ...
      if (h != null)
        return e(gt(h, 32), "invalid yParityAndS"), { v: tt(h)[0] & 128 ? 28 : 27 };
      if (u != null) {
        switch (et(u, "sig.yParity")) {
          case 0:
            return { v: 27 };
          case 1:
            return { v: 28 };
    ...
    return o && A(a, xs, o), e(t.yParity == null || et(t.yParity, "sig.yParity") === a.yParity, "yParity mismatch"), e(t.yParityAndS == null || t.yParityAndS === a.yParityAndS, "yParityAndS mismatch"), a;
  }
};
...
const Um = class Is {
   ...
   */
  constructor(t) {
    C(this, qn), O(Kr(t) === 32, "invalid private key", "privateKey", "[REDACTED]"), A(this, qn, W(t));
  }
  /**
   *  The private key.
   */
   ...
   */
  sign(t) {
    O(Kr(t) === 32, "invalid digest length", "digest", t);
  ...
  computeSharedSecret(t) {
    ...
    return W(Qn.getSharedSecret(Yt(f(this, qn)), tt(e), !1));
  }
  /**
  ...
  static recoverPublicKey(t, e) {
    O(Kr(t) === 32, "invalid digest length", "digest", t);
    const r = an.from(e);
    let s = Qn.Signature.fromCompact(Yt(xt([r.r, r.s])));
    s = s.addRecoveryBit(r.yParity);
    const i = s.recoverPublicKey(Yt(t));
    return O(i != null, "invalid signautre for digest", "signature", e), "0x" + i.toHex(!1);
  }
  /**
...
let hu = Um;
const Lm = BigInt(0), Dm = BigInt(36);
function Ih(n) {
  n = n.toLowerCase();
...
function ft(n) {
  if (O(typeof n == "string", "invalid address", "address", n), n.match(/^(0x)?[0-9a-fA-F]{40}$/)) {
    n.startsWith("0x") || (n = "0x" + n);
    const t = Ih(n);
    return O(!n.match(/([A-F].*[a-f])|([a-f].*[A-F])/) || t === n, "bad address checksum", "address", n), t;
  }
  if (n.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
    O(n.substring(2, 4) === Fm(n), "bad icap checksum", "address", n);
    let t = Hm(n.substring(4)).toString(16);
    for (; t.length < 40; )
      t = "0" + t;
    return Ih("0x" + t);
  }
  O(!1, "invalid address", "address", n);
}
function _m(n) {
  const t = ft(n.from);
  let e = z(n.nonce, "tx.nonce").toString(16);
  return e === "0" ? e = "0x" : e.length % 2 ? e = "0x0" + e : e = "0x" + e, ft(Nt(Ot(rs([t, e])), 12));
}
function Wd(n) {
...
async function xc(n, t) {
  const e = await t;
  return (e == null || e === "0x0000000000000000000000000000000000000000") && (D(typeof n != "string", "unconfigured name", "UNCONFIGURED_NAME", { value: n }), O(!1, "invalid AddressLike value; did not resolve to a value address", "target", n)), ft(e);
}
function te(n, t) {
  if (typeof n == "string")
  ...
  if (n && typeof n.then == "function")
    return xc(n, n);
  O(!1, "unsupported addressable value", "target", n);
}
const dn = {};
function j(n, t) {
  let e = !1;
  return t < 0 && (e = !0, t *= -1), new ce(dn, `${e ? "" : "u"}int${t}`, n, { signed: e, width: t });
}
function ct(n, t) {
  return new ce(dn, `bytes${t || ""}`, n, { size: t });
}
const Oh = Symbol.for("_ethers_typed");
var Ns;
const Gm = class Kn {
  /**
   *  @_ignore:
   */
  constructor(t, e, r, s) {
    S(this, "type"), S(this, "value"), C(this, Ns), S(this, "_typedSymbol"), s == null && (s = null), Do(dn, t, "Typed"), q(this, { _typedSymbol: Oh, type: e, value: r }), A(this, Ns, s), this.format();
  }
  /**
   ...
   */
  static isTyped(t) {
    return t && typeof t == "object" && "_typedSymbol" in t && t._typedSymbol === Oh;
  }
  /**
...
function zd(n, t, e) {
  ...
  if (Array.isArray(e))
    ...
    O(!1, "invalid tuple value", "tuple", e);
  O(t.length === r.length, "types/value length mismatch", "tuple", e);
...
let jm = class extends Rn {
  ...
  encode(t, e) {
    const r = ce.dereference(e, "array");
    Array.isArray(r) || this._throwError("expected array value", r);
    let s = this.length;
    s === -1 && (s = r.length, t.writeValue(r.length)), Yf(r.length, s, "coder array" + (this.localName ? " " + this.localName : ""));
    let i = [];
...
let zm = class extends qd {
  ...
  encode(t, e) {
    let r = Yt(ce.dereference(e, this.type));
...
const qm = new Uint8Array([]);
let Km = class extends Rn {
  constructor(t) {
    super("null", "", t, !1);
  }
  defaultValue() {
  ...
  encode(t, e) {
    return e != null && this._throwError("not null", e), t.writeBytes(qm);
  }
  decode(t) {
    return t.readBytes(0), null;
  }
};
const Jm = BigInt(0), Zm = BigInt(1), Ym = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
class Xm extends Rn {
  constructor(t, e, r) {
  ...
  encode(t, e) {
    let r = z(ce.dereference(e, this.type)), s = Hr(Ym, Xt * 8);
    if (this.signed) {
      let i = Hr(s, this.size * 8 - 1);
      (r > i || r < -(i + Zm)) && this._throwError("value out-of-bounds", e), r = ru(r, 8 * Xt);
    } else (r < Jm || r > Hr(s, this.size * 8)) && this._throwError("value out-of-bounds", e);
    return t.writeValue(r);
  }
  decode(t) {
...
let tw = class extends qd {
  ...
  encode(t, e) {
    return super.encode(t, Ve(ce.dereference(e, "string")));
  }
  decode(t) {
  ...
  encode(t, e) {
    const r = ce.dereference(e, "tuple");
    return zd(t, this.coders, r);
  }
  decode(t) {
...
function nw(n) {
  ...
  for (; ; ) {
    ...
    if (x == 0) break;
    w.push(x);
    let B = I + Math.floor(v * i[x] / s), _ = I + Math.floor(v * i[x + 1] / s) - 1;
    for (; !((B ^ _) & b); )
      g = g << 1 & d | h(), B = B << 1 & d, _ = _ << 1 & d | 1;
    for (; B & ~_ & y; )
      g = g & b | g << 1 & d >>> 1 | h(), B = B << 1 ^ b, _ = (_ ^ b) << 1 | b | 1;
    I = B, v = 1 + _ - B;
  }
  let T = r - 4;
  return w.map((k) => {
...
function ow(n, t) {
  let e = Array(n);
  for (let r = 0, s = 0; r < n; r++) e[r] = s += iw(t());
  return e;
}
function Bo(n, t = 0) {
  let e = [];
...
function Yd(n, t, e) {
  ...
  for (let s = 0; s < t; s++)
    ow(n, e).forEach((i, o) => r[o].push(i));
  return r;
}
function aw(n, t) {
  let e = 1 + t(), r = t(), s = ko(t);
  return Yd(s.length, 1 + n, t).flatMap((i, o) => {
    let [c, ...a] = i;
...
function cw(n, t) {
  let e = 1 + t();
  return Yd(e, 1 + n, t).map((r) => [r[0], r.slice(1)]);
}
function lw(n) {
  let t = [], e = Bo(n);
  return s(r([]), []), t;
...
function bw() {
  let n = Kd(dw);
  dl = new Map(Jd(n).flatMap((t, e) => t.map((r) => [r, e + 1 << 24]))), Sh = new Set(Bo(n)), pl = /* @__PURE__ */ new Map(), ua = /* @__PURE__ */ new Map();
  for (let [t, e] of Zd(n)) {
...
function Aw(n, t) {
  if (n >= Ma && n < yw && t >= Ha && t < mw)
    return So + (n - Ma) * Ga + (t - Ha) * ai;
  if (rp(n) && t > _a && t < ww && (n - So) % ai == 0)
    return n + (t - _a);
  {
    let e = ua.get(n);
...
const Th = 45, op = ".", ap = 65039, cp = 1, Va = (n) => Array.from(n);
function To(n, t) {
  return n.P.has(t) || n.Q.has(t);
}
class xw extends Array {
  get is_emoji() {
    return !0;
  }
  // free tagging system
}
let gl, lp, Vr, yl, up, Ks, Ic, Os, yr, Rh, ml;
function du() {
  if (gl) return;
  let n = Kd(ew);
  const t = () => Bo(n), e = () => new Set(t()), r = (h, u) => u.forEach((p) => h.add(p));
  gl = new Map(Zd(n)), lp = e(), Vr = t(), yl = new Set(t().map((h) => Vr[h])), Vr = new Set(Vr), up = e(), e();
  let s = Jd(n), i = n();
  const o = () => {
  ...
  }), Ic = e(), Os = /* @__PURE__ */ new Map();
  let c = t().concat(Va(Ic)).sort((h, u) => h - u);
  c.forEach((h, u) => {
    let p = n(), b = c[u] = p ? c[u - p] : { V: [], M: /* @__PURE__ */ new Map() };
    b.V.push(h), Ic.has(h) || Os.set(h, b);
  });
  for (let { V: h, M: u } of new Set(Os.values())) {
    let p = [];
    for (let y of h) {
  ...
  for (let h of yr)
    !Os.has(h) && !a.has(h) && Os.set(h, cp);
  r(yr, ip(yr)), Rh = lw(n).map((h) => xw.from(h)).sort(fw), ml = /* @__PURE__ */ new Map();
  for (let h of Rh) {
    let u = [ml];
    for (let p of h) {
      let b = u.map((y) => {
...
function Xa(n, t = 1 / 0, e = Xd) {
  let r = [];
  Bw(n[0]) && r.push("◌"), n.length > t && (t >>= 1, n = [...n.slice(0, t), 8230, ...n.slice(-t)]);
  let s = 0, i = n.length;
  for (let o = 0; o < i; o++) {
    let c = n[o];
    hp(c) && (r.push(oi(n.slice(s, o))), r.push(e(c)), s = o + 1);
  }
...
function kw(n) {
  return Cw(Sw(n, vw, Lw));
}
function Sw(n, t, e) {
  if (!n) return [];
  du();
  let r = 0;
  return n.split(op).map((s) => {
    let i = hw(s), o = {
      input: i,
      offset: r
    ...
    r += i.length + 1;
    try {
      let c = o.tokens = Uw(i, t, e), a = c.length, l;
      if (!a)
        throw new Error("empty label");
      let h = o.output = c.flat();
      if (Nw(h), !(o.emoji = a > 1 || c[0].is_emoji) && h.every((u) => u < 128))
        Iw(h), l = "ASCII";
      else {
...
function Rw(n) {
  ...
  for (let e of n) {
    ...
    if (!r.length)
      throw Ks.some((s) => To(s, e)) ? dp(t[0], e) : fp(e);
...
pp.fill(0);
function Ch(n) {
  return O(n.length !== 0, "invalid ENS name; empty component", "comp", n), n;
}
function gp(n) {
  const t = Ve(Fw(n)), e = [];
  if (n.length === 0)
  ...
  return O(r < t.length, "invalid ENS name; empty component", "name", n), e.push(Ch(t.slice(r))), e;
}
function Fw(n) {
  try {
    if (n.length === 0)
    ...
    O(!1, `invalid ENS name (${t.message})`, "name", n);
  }
}
function wl(n) {
  O(typeof n == "string", "invalid ENS name; not a string", "name", n), O(n.length, "invalid ENS name (empty label)", "name", n);
  let t = pp;
  const e = gp(n);
  for (; e.length; )
    t = Ot(xt([t, Ot(e.pop())]));
...
function Mw(n, t) {
  const e = t;
  return O(e <= 255, "DNS encoded label cannot exceed 255", "length", e), W(xt(gp(n).map((r) => {
    O(r.length <= e, `label ${JSON.stringify(n)} exceeds ${e} bytes`, "name", n);
...
function Nc(n, t) {
  return {
    address: ft(n),
    storageKeys: t.map((e, r) => (O(gt(e, 32), "invalid slot", `storageKeys[${r}]`, e), e.toLowerCase()))
  };
}
function fs(n) {
  if (Array.isArray(n))
    return n.map((e, r) => Array.isArray(e) ? (O(e.length === 2, "invalid slot set", `value[${r}]`, e), Nc(e[0], e[1])) : (O(e != null && typeof e == "object", "invalid address-slot set", "value", n), Nc(e.address, e.storageKeys)));
  O(n != null && typeof n == "object", "invalid access list", "value", n);
...
function Hw(n) {
  let t;
  return typeof n == "string" ? t = hu.computePublicKey(n, !1) : t = n.publicKey, ft(Ot("0x" + t.substring(4)).substring(26));
}
function yp(n, t) {
  return Hw(hu.recoverPublicKey(n, t));
}
const Dt = BigInt(0), _w = BigInt(2), Gw = BigInt(27), Vw = BigInt(28), $w = BigInt(35), jw = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), Oc = 4096 * 32;
function Ph(n, t) {
  let e = n.toString(16);
  for (; e.length < 2; )
    e = "0" + e;
  return e += hr(t).substring(4), "0x" + e;
}
function tc(n) {
...
function Mo(n, t) {
  return n === "0x" ? 0 : et(n, t);
}
function St(n, t) {
  if (n === "0x")
    return Dt;
  const e = z(n, t);
  return O(e <= jw, "value exceeds uint size", t, e), e;
}
function mt(n, t) {
  const e = z(n, "value"), r = Lt(e);
  return O(r.length <= 32, "value too large", `tx.${t}`, e), r;
}
function mu(n) {
  return fs(n).map((t) => [t.address, t.storageKeys]);
}
function Ww(n, t) {
  O(Array.isArray(n), `invalid ${t}`, "value", n);
  for (let e = 0; e < n.length; e++)
    O(gt(n[e], 32), "invalid ${ param } hash", `value[${e}]`, n[e]);
  return n;
}
function zw(n) {
  const t = Ka(n);
  O(Array.isArray(t) && (t.length === 9 || t.length === 6), "invalid field count for legacy transaction", "data", n);
  const e = {
    type: 0,
    nonce: Mo(t[0], "nonce"),
    gasPrice: St(t[1], "gasPrice"),
    gasLimit: St(t[2], "gasLimit"),
    to: tc(t[3]),
    value: St(t[4], "value"),
    data: W(t[5]),
    chainId: Dt
  ...
  if (t.length === 6)
    return e;
  const r = St(t[6], "v"), s = St(t[7], "r"), i = St(t[8], "s");
  if (s === Dt && i === Dt)
    e.chainId = r;
  else {
    let o = (r - $w) / _w;
    o < Dt && (o = Dt), e.chainId = o, O(o !== Dt || r === Gw || r === Vw, "non-canonical legacy v", "v", t[6]), e.signature = an.from({
      r: sn(t[7], 32),
      s: sn(t[8], 32),
      v: r
    });
...
function Qw(n, t) {
  ...
  let r = Dt;
  if (n.chainId != Dt)
    r = z(n.chainId, "tx.chainId"), O(!t || t.networkV == null || t.legacyChainId === r, "tx.chainId/sig.v mismatch", "sig", t);
  else if (n.signature) {
  ...
  return r !== Dt ? s = an.getChainIdV(r, t.v) : BigInt(t.v) !== s && O(!1, "tx.chainId/sig.v mismatch", "sig", t), e.push(Lt(s)), e.push(Lt(t.r)), e.push(Lt(t.s)), rs(e);
}
function wu(n, t) {
  let e;
  try {
    ...
    O(!1, "invalid yParity", "yParity", t[0]);
  }
  const r = sn(t[1], 32), s = sn(t[2], 32), i = an.from({ r, s, yParity: e });
  n.signature = i;
}
function qw(n) {
  const t = Ka(tt(n).slice(1));
  O(Array.isArray(t) && (t.length === 9 || t.length === 12), "invalid field count for transaction type: 2", "data", W(n));
  const e = {
    type: 2,
    chainId: St(t[0], "chainId"),
    nonce: Mo(t[1], "nonce"),
    maxPriorityFeePerGas: St(t[2], "maxPriorityFeePerGas"),
    maxFeePerGas: St(t[3], "maxFeePerGas"),
    gasPrice: null,
    gasLimit: St(t[4], "gasLimit"),
    to: tc(t[5]),
    value: St(t[6], "value"),
    data: W(t[7]),
...
function Kw(n, t) {
  ...
  return t && (e.push(mt(t.yParity, "yParity")), e.push(Lt(t.r)), e.push(Lt(t.s))), xt(["0x02", rs(e)]);
}
function Jw(n) {
  const t = Ka(tt(n).slice(1));
  O(Array.isArray(t) && (t.length === 8 || t.length === 11), "invalid field count for transaction type: 1", "data", W(n));
  const e = {
    type: 1,
    chainId: St(t[0], "chainId"),
    nonce: Mo(t[1], "nonce"),
    gasPrice: St(t[2], "gasPrice"),
    gasLimit: St(t[3], "gasLimit"),
    to: tc(t[4]),
    value: St(t[5], "value"),
    data: W(t[6]),
...
function Zw(n, t) {
  ...
  return t && (e.push(mt(t.yParity, "recoveryParam")), e.push(Lt(t.r)), e.push(Lt(t.s))), xt(["0x01", rs(e)]);
}
function Yw(n) {
  let t = Ka(tt(n).slice(1)), e = "3", r = null;
  if (t.length === 4 && Array.isArray(t[0])) {
    e = "3 (network format)";
    const i = t[1], o = t[2], c = t[3];
    O(Array.isArray(i), "invalid network format: blobs not an array", "fields[1]", i), O(Array.isArray(o), "invalid network format: commitments not an array", "fields[2]", o), O(Array.isArray(c), "invalid network format: proofs not an array", "fields[3]", c), O(i.length === o.length, "invalid network format: blobs/commitments length mismatch", "fields", t), O(i.length === c.length, "invalid network format: blobs/proofs length mismatch", "fields", t), r = [];
  ...
  O(Array.isArray(t) && (t.length === 11 || t.length === 14), `invalid field count for transaction type: ${e}`, "data", W(n));
  const s = {
    type: 3,
    chainId: St(t[0], "chainId"),
    nonce: Mo(t[1], "nonce"),
    ...
    data: W(t[7]),
    accessList: yu(t[8], "accessList"),
    maxFeePerBlobGas: St(t[9], "maxFeePerBlobGas"),
    blobVersionedHashes: t[10]
  };
  r && (s.blobs = r), O(s.to != null, `invalid address for transaction type: ${e}`, "data", n), O(Array.isArray(s.blobVersionedHashes), "invalid blobVersionedHashes: must be an array", "data", n);
  for (let i = 0; i < s.blobVersionedHashes.length; i++)
    O(gt(s.blobVersionedHashes[i], 32), `invalid blobVersionedHash at index ${i}: must be length 32`, "data", n);
...
function Xw(n, t, e) {
  const r = [
    ...
    Ww(n.blobVersionedHashes || [], "blobVersionedHashes")
  ];
  return t && (r.push(mt(t.yParity, "yParity")), r.push(Lt(t.r)), r.push(Lt(t.s)), e) ? xt([
    "0x03",
    rs([
      r,
      e.map((s) => s.data),
...
var hn, _i, Gi, Vi, $i, ji, Wi, zi, Qi, qi, Ki, Ji, Bs, mr, Jn, wr, Zi, ha;
const tb = class Zn {
  /**
   *  Creates a new Transaction with default values.
   */
  constructor() {
    C(this, Zi), C(this, hn), C(this, _i), C(this, Gi), C(this, Vi), C(this, $i), C(this, ji), C(this, Wi), C(this, zi), C(this, Qi), C(this, qi), C(this, Ki), C(this, Ji), C(this, Bs), C(this, mr), C(this, Jn), C(this, wr), A(this, hn, null), A(this, _i, null), A(this, Vi, 0), A(this, $i, Dt), A(this, ji, null), A(this, Wi, null), A(this, zi, null), A(this, Gi, "0x"), A(this, Qi, Dt), A(this, qi, Dt), A(this, Ki, null), A(this, Ji, null), A(this, Bs, null), A(this, mr, null), A(this, wr, null), A(this, Jn, null);
  }
  /**
  ...
  set maxFeePerBlobGas(t) {
    A(this, Bs, t == null ? null : z(t, "maxFeePerBlobGas"));
  }
  /**
  ...
  set blobVersionedHashes(t) {
    if (t != null) {
      O(Array.isArray(t), "blobVersionedHashes must be an Array", "value", t), t = t.slice();
      for (let e = 0; e < t.length; e++)
        O(gt(t[e], 32), "invalid blobVersionedHash", `value[${e}]`, t[e]);
    }
    A(this, mr, t);
  }
  /**
  ...
  set blobs(t) {
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      if (eu(i)) {
        ...
        let o = tt(i);
        if (O(o.length <= Oc, "blob is too large", `blobs[${s}]`, i), o.length !== Oc) {
          const l = new Uint8Array(Oc);
          l.set(o), o = l;
        }
   ...
   */
  get hash() {
    return this.signature == null ? null : Ot(F(this, Zi, ha).call(this, !0, !1));
  }
  /**
   ...
   */
  inferTypes() {
    const t = this.gasPrice != null, e = this.maxFeePerGas != null || this.maxPriorityFeePerGas != null, r = this.accessList != null, s = f(this, Bs) != null || f(this, mr);
  ...
  static from(t) {
    ...
    const e = new Zn();
    return t.type != null && (e.type = t.type), t.to != null && (e.to = t.to), t.nonce != null && (e.nonce = t.nonce), t.gasLimit != null && (e.gasLimit = t.gasLimit), t.gasPrice != null && (e.gasPrice = t.gasPrice), t.maxPriorityFeePerGas != null && (e.maxPriorityFeePerGas = t.maxPriorityFeePerGas), t.maxFeePerGas != null && (e.maxFeePerGas = t.maxFeePerGas), t.maxFeePerBlobGas != null && (e.maxFeePerBlobGas = t.maxFeePerBlobGas), t.data != null && (e.data = t.data), t.value != null && (e.value = t.value), t.chainId != null && (e.chainId = t.chainId), t.signature != null && (e.signature = an.from(t.signature)), t.accessList != null && (e.accessList = t.accessList), t.blobVersionedHashes != null && (e.blobVersionedHashes = t.blobVersionedHashes), t.kzg != null && (e.kzg = t.kzg), t.blobs != null && (e.blobs = t.blobs), t.hash != null && (O(e.isSigned(), "unsigned transaction cannot define '.hash'", "tx", t), O(e.hash === t.hash, "hash mismatch", "tx", t)), t.from != null && (O(e.isSigned(), "unsigned transaction cannot define '.from'", "tx", t), O(e.from.toLowerCase() === (t.from || "").toLowerCase(), "from mismatch", "tx", t)), e;
  }
};
hn = /* @__PURE__ */ new WeakMap(), _i = /* @__PURE__ */ new WeakMap(), Gi = /* @__PURE__ */ new WeakMap(), Vi = /* @__PURE__ */ new WeakMap(), $i = /* @__PURE__ */ new WeakMap(), ji = /* @__PURE__ */ new WeakMap(), Wi = /* @__PURE__ */ new WeakMap(), zi = /* @__PURE__ */ new WeakMap(), Qi = /* @__PURE__ */ new WeakMap(), qi = /* @__PURE__ */ new WeakMap(), Ki = /* @__PURE__ */ new WeakMap(), Ji = /* @__PURE__ */ new WeakMap(), Bs = /* @__PURE__ */ new WeakMap(), mr = /* @__PURE__ */ new WeakMap(), Jn = /* @__PURE__ */ new WeakMap(), wr = /* @__PURE__ */ new WeakMap(), Zi = /* @__PURE__ */ new WeakSet(), ha = function(n, t) {
  ...
  switch (this.inferType()) {
    ...
    case 2:
      return Kw(this, e);
    case 3:
      return Xw(this, e, t ? this.blobs : null);
  }
  D(!1, "unsupported transaction type", "UNSUPPORTED_OPERATION", { operation: ".serialized" });
};
let mp = tb;
const eb = new RegExp("^bytes([0-9]+)$"), nb = new RegExp("^(u?int)([0-9]*)$"), rb = new RegExp("^(.*)\\[([0-9]*)\\]$");
function wp(n, t, e) {
  switch (n) {
    case "address":
      return tt(e ? sn(t, 32) : ft(t));
    case "string":
      return Ve(t);
    case "bytes":
      return tt(t);
    case "bool":
      return t = t ? "0x01" : "0x00", tt(e ? sn(t, 32) : t);
  }
  let r = n.match(nb);
  if (r) {
    let s = r[1] === "int", i = parseInt(r[2] || "256");
    return O((!r[2] || r[2] === String(i)) && i % 8 === 0 && i !== 0 && i <= 256, "invalid number type", "type", n), e && (i = 256), s && (t = ru(t, i)), tt(sn(Lt(t), i / 8));
  }
  if (r = n.match(eb), r) {
    const s = parseInt(r[1]);
    return O(String(s) === r[1] && s !== 0 && s <= 32, "invalid bytes type", "type", n), O(Kr(t) === s, `invalid value for ${n}`, "value", t), e ? tt(nu(t, 32)) : t;
  }
  if (r = n.match(rb), r && Array.isArray(t)) {
    const s = r[1], i = parseInt(r[2] || String(t.length));
    O(i === t.length, `invalid array length for ${n}`, "value", t);
    const o = [];
    return t.forEach(function(c) {
      o.push(wp(s, c, !0));
    }), tt(xt(o));
  }
  O(!1, "invalid type", "type", n);
}
function sb(n, t) {
  O(n.length === t.length, "wrong number of values; expected ${ types.length }", "values", t);
  const e = [];
...
bp.fill(0);
const ob = BigInt(-1), Ap = BigInt(0), Ep = BigInt(1), ab = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
function cb(n) {
  const t = tt(n), e = t.length % 32;
  return e ? xt([t, bp.slice(e)]) : W(t);
}
const lb = ur(Ep, 32), ub = ur(Ap, 32), Uh = {
  name: "string",
  version: "string",
  chainId: "uint256",
...
function Lh(n) {
  return function(t) {
    return O(typeof t == "string", `invalid domain value for ${JSON.stringify(n)}`, `domain.${n}`, t), t;
  };
}
const hb = {
  name: Lh("name"),
  ...
  chainId: function(n) {
    ...
    return O(t >= 0, "invalid chain ID", "domain.chainId", n), Number.isSafeInteger(t) ? Number(t) : Hs(t);
  },
  verifyingContract: function(n) {
    ...
    O(!1, 'invalid domain value "verifyingContract"', "domain.verifyingContract", n);
  },
  salt: function(n) {
    const t = tt(n, "domain.salt");
    return O(t.length === 32, 'invalid domain value "salt"', "domain.salt", n), W(t);
  }
};
function bl(n) {
  {
    ...
    if (t) {
      ...
      O(r % 8 === 0 && r !== 0 && r <= 256 && t[2] === String(r), "invalid numeric width", "type", n);
      const s = Hr(ab, e ? r - 1 : r), i = e ? (s + Ep) * ob : Ap;
      return function(o) {
        const c = z(o, "value");
        return O(c >= i && c <= s, `value out-of-bounds for ${n}`, "value", c), ur(e ? ru(c, 256) : c, 32);
      };
    }
  }
  {
    ...
    if (t) {
      ...
      return O(e !== 0 && e <= 32 && t[1] === String(e), "invalid bytes width", "type", n), function(r) {
        const s = tt(r);
        return O(s.length === e, `invalid length for ${n}`, "value", r), cb(r);
      };
    }
  }
  switch (n) {
...
const fb = class Se {
   ...
   */
  constructor(t) {
    C(this, Al), S(this, "primaryType"), C(this, da), C(this, ar), C(this, Yi), A(this, ar, /* @__PURE__ */ new Map()), A(this, Yi, /* @__PURE__ */ new Map());
    ...
    for (const a in i) {
      ...
      for (const h of i[a]) {
        O(!l.has(h.name), `duplicate variable name ${JSON.stringify(h.name)} in ${JSON.stringify(a)}`, "types", t), l.add(h.name);
        const u = fa(h.type).base;
        O(u !== a, `circular type reference to ${JSON.stringify(u)}`, "types", t), !bl(u) && (O(r.has(u), `unknown type ${JSON.stringify(u)}`, "types", t), r.get(u).push(a), e.get(a).add(u));
      }
    }
    const o = Array.from(r.keys()).filter((a) => r.get(a).length === 0);
    O(o.length !== 0, "missing primary type", "types", t), O(o.length === 1, `ambiguous primary types or unused types: ${o.map((a) => JSON.stringify(a)).join(", ")}`, "types", t), q(this, { primaryType: o[0] });
    function c(a, l) {
      O(!l.has(a), `circular type reference to ${JSON.stringify(a)}`, "types", t), l.add(a);
    ...
    for (const [a, l] of s) {
      ...
      h.sort(), f(this, ar).set(a, Dh(a, i[a]) + h.map((u) => Dh(u, i[u])).join(""));
    }
  }
  /**
   *  The types.
  ...
  getEncoder(t) {
    ...
    return e || (e = F(this, Al, vp).call(this, t), f(this, Yi).set(t, e)), e;
  }
  /**
   *  Return the full type for %%name%%.
   */
  encodeType(t) {
    const e = f(this, ar).get(t);
  ...
  _visit(t, e, r) {
    ...
    const s = fa(t).array;
    if (s)
      return O(s.count === -1 || s.count === e.length, `array length mismatch; expected length ${s.count}`, "value", e), e.map((o) => this._visit(s.prefix, o, r));
  ...
  static getPrimaryType(t) {
    return Se.from(t).primaryType;
  }
  /**
   *  Return the hashed struct for %%value%% using %%types%% and %%name%%.
   */
  static hashStruct(t, e, r) {
    return Se.from(e).hashStruct(t, r);
  }
  /**
  ...
  static hashDomain(t) {
    ...
    for (const r in t) {
      if (t[r] == null)
        continue;
      const s = Uh[r];
      O(s, `invalid typed-data domain key: ${JSON.stringify(r)}`, "domain", t), e.push({ name: r, type: s });
    }
    return e.sort((r, s) => Bc.indexOf(r.name) - Bc.indexOf(s.name)), Se.hashStruct("EIP712Domain", { EIP712Domain: e }, t);
  }
  /**
  ...
  static getPayload(t, e, r) {
    ...
    Bc.forEach((a) => {
      const l = t[a];
      l != null && (s[a] = hb[a](l), i.push({ name: a, type: Uh[a] }));
    });
    const o = Se.from(e);
    e = o.types;
    const c = Object.assign({}, e);
    return O(c.EIP712Domain == null, "types must not contain EIP712Domain type", "types.EIP712Domain", e), c.EIP712Domain = i, o.encode(r), {
      types: c,
      domain: s,
      ...
      message: o.visit(r, (a, l) => {
        ...
        switch (a) {
          ...
          case "bool":
            return !!l;
          case "string":
            return O(typeof l == "string", "invalid string", "value", l), l;
        }
        O(!1, "unsupported type", "type", a);
      })
    };
  }
};
da = /* @__PURE__ */ new WeakMap(), ar = /* @__PURE__ */ new WeakMap(), Yi = /* @__PURE__ */ new WeakMap(), Al = /* @__PURE__ */ new WeakSet(), vp = function(n) {
  {
    const r = bl(n);
    if (r)
      return r;
  ...
  if (t) {
    ...
    return (i) => {
      O(t.count === -1 || t.count === i.length, `array length mismatch; expected length ${t.count}`, "value", i);
      let o = i.map(s);
      return f(this, ar).has(r) && (o = o.map(Ot)), Ot(xt(o));
    };
  }
  const e = this.types[n];
  if (e) {
    const r = ss(f(this, ar).get(n));
    return (s) => {
      const i = e.map(({ name: o, type: c }) => {
        const a = this.getEncoder(c)(s[o]);
        return f(this, ar).has(c) ? Ot(a) : a;
      });
      return i.unshift(r), xt(i);
    };
  }
  O(!1, `unknown type: ${n}`, "type", n);
};
let Fh = fb;
function ee(n) {
...
const db = "external public payable override", pb = ee(db.split(" ")), xp = "constant external internal payable private public pure view override", gb = ee(xp.split(" ")), Ip = "constructor error event fallback function receive struct", Np = ee(Ip.split(" ")), Op = "calldata memory storage payable indexed", yb = ee(Op.split(" ")), mb = "tuple returns", wb = [Ip, Op, mb, xp].join(" "), bb = ee(wb.split(" ")), Ab = {
  "(": "OPEN_PAREN",
  ")": "CLOSE_PAREN",
  "[": "OPEN_BRACKET",
  "]": "CLOSE_BRACKET",
  ",": "COMMA",
  "@": "AT"
}, Eb = new RegExp("^(\\s*)"), vb = new RegExp("^([0-9]+)"), xb = new RegExp("^([a-zA-Z$_][a-zA-Z0-9$_]*)"), Bp = new RegExp("^([a-zA-Z$_][a-zA-Z0-9$_]*)$"), kp = new RegExp("^(address|bool|bytes([0-9]*)|string|u?int([0-9]*))$");
var Wt, Ze, pa, El;
const Sp = class Tp {
  constructor(t) {
...
Wt = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakMap(), pa = /* @__PURE__ */ new WeakSet(), El = function(n = 0, t = 0) {
  return new Sp(f(this, Ze).slice(n, t).map((e) => Object.freeze(Object.assign({}, e, {
    match: e.match - n,
...
function fr(n) {
  ...
  let r = [], s = [], i = 0;
  for (; i < n.length; ) {
    let o = n.substring(i), c = o.match(Eb);
    ...
    if (c = o.match(xb), c) {
      if (a.text = c[1], i += a.text.length, bb.has(a.text)) {
        a.type = "KEYWORD";
        continue;
      }
      if (a.text.match(kp)) {
...
const Ib = new RegExp(/^(.*)\[([0-9]*)\]$/);
function Hh(n) {
  const t = n.match(kp);
  if (O(t, "invalid type", "type", n), n === "uint")
    return "uint256";
  if (n === "int")
    return "int256";
  if (t[2]) {
    const e = parseInt(t[2]);
    O(e !== 0 && e <= 32, "invalid bytes length", "type", n);
  } else if (t[3]) {
    const e = parseInt(t[3]);
    O(e !== 0 && e <= 256 && e % 8 === 0, "invalid numeric width", "type", n);
  }
  return n;
}
const vt = {}, le = Symbol.for("_ethers_internal"), _h = "_ParamTypeInternal", Gh = "_ErrorInternal", Vh = "_EventInternal", $h = "_ConstructorInternal", jh = "_FallbackInternal", Wh = "_FunctionInternal", zh = "_StructInternal";
var wo, ga;
const Nb = class Te {
  /**
   *  @private
  ...
  constructor(t, e, r, s, i, o, c, a) {
    if (C(this, wo), S(this, "name"), S(this, "type"), S(this, "baseType"), S(this, "indexed"), S(this, "components"), S(this, "arrayLength"), S(this, "arrayChildren"), Do(t, vt, "ParamType"), Object.defineProperty(this, le, { value: _h }), o && (o = Object.freeze(o.slice())), s === "array") {
      if (c == null || a == null)
        throw new Error("");
  ...
  static from(t, e) {
    ...
    if (typeof t == "string")
      try {
        return Te.from(fr(t), e);
      } catch {
        O(!1, "invalid param type", "obj", t);
      }
    else if (t instanceof Cn) {
      let c = "", a = "", l = null;
      Sn(t, ee(["tuple"])).has("tuple") || t.peekType("OPEN_PAREN") ? (a = "tuple", l = t.popParams().map((y) => Te.from(y)), c = `tuple(${l.map((y) => y.format()).join(",")})`) : (c = Hh(t.popType("TYPE")), a = c);
      let h = null, u = null;
      for (; t.length && t.peekType("BRACKET"); ) {
        const y = t.pop();
        h = new Te(vt, "", c, a, null, l, u, h), u = y.value, c += y.text, a = "array", l = null;
      }
      let p = null;
      if (Sn(t, yb).has("indexed")) {
        if (!e)
          throw new Error("");
        p = !0;
      }
      ...
      return new Te(vt, b, c, a, p, l, u, h);
    }
    const r = t.name;
    O(!r || typeof r == "string" && r.match(Bp), "invalid name", "obj.name", r);
    let s = t.indexed;
    s != null && (O(e, "parameter cannot be indexed", "obj.indexed", t.indexed), s = !!s);
    let i = t.type, o = i.match(Ib);
    if (o) {
      const c = parseInt(o[2] || "-1"), a = Te.from({
        type: o[1],
        components: t.components
      });
      return new Te(vt, r || "", i, "array", s, null, c, a);
    }
    if (i === "tuple" || i.startsWith(
      ...
      const c = t.components != null ? t.components.map((a) => Te.from(a)) : null;
      return new Te(vt, r || "", i, "tuple", s, c, null, null);
    }
    return i = Hh(t.type), new Te(vt, r || "", i, i, s, null, null, null);
  }
  /**
...
class os {
   ...
   */
  constructor(t, e, r) {
    S(this, "type"), S(this, "inputs"), Do(t, vt, "Fragment"), r = Object.freeze(r.slice()), q(this, { type: e, inputs: r });
  }
  /**
...
class nc extends os {
   ...
   */
  constructor(t, e, r, s) {
    super(t, e, s), S(this, "name"), O(typeof r == "string" && r.match(Bp), "invalid identifier", "name", r), s = Object.freeze(s.slice()), q(this, { name: r });
  }
}
function Ro(n, t) {
...
let gn = class Xi extends nc {
   ...
   */
  constructor(t, e, r) {
    super(t, "error", e, r), Object.defineProperty(this, le, { value: Gh });
  }
  /**
  ...
  static from(t) {
    ...
    if (t instanceof Cn) {
      ...
      return is(t), new Xi(vt, e, r);
    }
    return new Xi(vt, t.name, t.inputs ? t.inputs.map(ne.from) : []);
  }
  /**
...
class nn extends nc {
   ...
   */
  constructor(t, e, r, s) {
    super(t, "event", e, r), S(this, "anonymous"), Object.defineProperty(this, le, { value: Vh }), q(this, { anonymous: s });
  }
  /**
  ...
  static getTopicHash(t, e) {
    return e = (e || []).map((r) => ne.from(r)), new nn(vt, t, e, !1).topicHash;
  }
  /**
  ...
  static from(t) {
    ...
    if (typeof t == "string")
      try {
        ...
        O(!1, "invalid event fragment", "obj", t);
      }
    else if (t instanceof Cn) {
      const e = ec("event", t), r = kn(t, !0), s = !!Sn(t, ee(["anonymous"])).has("anonymous");
      return is(t), new nn(vt, e, r, s);
    }
    return new nn(vt, t.name, t.inputs ? t.inputs.map((e) => ne.from(e, !0)) : [], !!t.anonymous);
  }
  /**
   *  Returns ``true`` and provides a type guard if %%value%% is an
   *  **EventFragment**.
...
class Bn extends os {
   ...
   */
  constructor(t, e, r, s, i) {
    super(t, e, r), S(this, "payable"), S(this, "gas"), Object.defineProperty(this, le, { value: $h }), q(this, { payable: s, gas: i });
  }
  /**
  ...
  static from(t) {
    ...
    if (typeof t == "string")
      try {
        ...
        O(!1, "invalid constuctor fragment", "obj", t);
      }
    else if (t instanceof Cn) {
      Sn(t, ee(["constructor"]));
      const e = kn(t), r = !!Sn(t, pb).has("payable"), s = Cp(t);
      return is(t), new Bn(vt, "constructor", e, r, s);
    }
    return new Bn(vt, "constructor", t.inputs ? t.inputs.map(ne.from) : [], !!t.payable, t.gas != null ? t.gas : null);
  }
  /**
...
let Qh = class br extends os {
  constructor(t, e, r) {
    super(t, "fallback", e), S(this, "payable"), Object.defineProperty(this, le, { value: jh }), q(this, { payable: r });
  }
  /**
  ...
  static from(t) {
    ...
    if (typeof t == "string")
      try {
        ...
        O(!1, "invalid fallback fragment", "obj", t);
      }
    else if (t instanceof Cn) {
      const e = t.toString(), r = t.peekKeyword(ee(["fallback", "receive"]));
      if (O(r, "type must be fallback or receive", "obj", e), t.popKeyword(ee(["fallback", "receive"])) === "receive") {
        const o = kn(t);
        return O(o.length === 0, "receive cannot have arguments", "obj.inputs", o), Sn(t, ee(["payable"])), is(t), new br(vt, [], !0);
      }
      let s = kn(t);
      s.length ? O(s.length === 1 && s[0].type === "bytes", "invalid fallback inputs", "obj.inputs", s.map((o) => o.format("minimal")).join(", ")) : s = [ne.from("bytes")];
      const i = Rp(t);
      if (O(i === "nonpayable" || i === "payable", "fallback cannot be constants", "obj.stateMutability", i), Sn(t, ee(["returns"])).has("returns")) {
        const o = kn(t);
        O(o.length === 1 && o[0].type === "bytes", "invalid fallback outputs", "obj.outputs", o.map((c) => c.format("minimal")).join(", "));
      }
      return is(t), new br(vt, s, i === "payable");
    }
    if (t.type === "receive")
      return new br(vt, [], !0);
    if (t.type === "fallback") {
      const e = [ne.from("bytes")], r = t.stateMutability === "payable";
      return new br(vt, e, r);
    }
...
class rn extends nc {
  ...
  constructor(t, e, r, s, i, o) {
    super(t, "function", e, s), S(this, "constant"), S(this, "outputs"), S(this, "stateMutability"), S(this, "payable"), S(this, "gas"), Object.defineProperty(this, le, { value: Wh }), i = Object.freeze(i.slice()), q(this, { constant: r === "view" || r === "pure", gas: o, outputs: i, payable: r === "payable", stateMutability: r });
  }
  /**
  ...
  static getSelector(t, e) {
    return e = (e || []).map((r) => ne.from(r)), new rn(vt, t, "view", e, [], null).selector;
  }
  /**
  ...
  static from(t) {
    ...
    if (typeof t == "string")
      try {
        ...
        O(!1, "invalid function fragment", "obj", t);
      }
    else if (t instanceof Cn) {
      const r = ec("function", t), s = kn(t), i = Rp(t);
      let o = [];
      Sn(t, ee(["returns"])).has("returns") && (o = kn(t));
      const c = Cp(t);
      return is(t), new rn(vt, r, i, s, o, c);
    }
    let e = t.stateMutability;
    return e == null && (e = "payable", typeof t.constant == "boolean" ? (e = "view", t.constant || (e = "payable", typeof t.payable == "boolean" && !t.payable && (e = "nonpayable"))) : typeof t.payable == "boolean" && !t.payable && (e = "nonpayable")), new rn(vt, t.name, e, t.inputs ? t.inputs.map(ne.from) : [], t.outputs ? t.outputs.map(ne.from) : [], t.gas != null ? t.gas : null);
  }
  /**
   *  Returns ``true`` and provides a type guard if %%value%% is a
   *  **FunctionFragment**.
...
class Zr extends nc {
   ...
   */
  constructor(t, e, r) {
    super(t, "struct", e, r), Object.defineProperty(this, le, { value: zh });
  }
  /**
  ...
  static from(t) {
    if (typeof t == "string")
      try {
        ...
        O(!1, "invalid struct fragment", "obj", t);
      }
    else if (t instanceof Cn) {
      const e = ec("struct", t), r = kn(t);
      return is(t), new Zr(vt, e, r);
    }
    return new Zr(vt, t.name, t.inputs ? t.inputs.map(ne.from) : []);
  }
...
const Ob = new RegExp(/^bytes([0-9]*)$/), Bb = new RegExp(/^(u?int)([0-9]*)$/);
let kc = null, qh = 1024;
function kb(n, t, e, r) {
  ...
  return t.from && (a.from = ft(t.from)), It(s, "CALL_EXCEPTION", {
    action: n,
    data: e,
    reason: i,
    transaction: a,
...
const Sb = class vl {
   ...
   */
  encode(t, e) {
    Yf(e.length, t.length, "types/values length mismatch");
  ...
  decode(t, e, r) {
    ...
    return new la(s, "_").decode(new uy(e, r, qh));
  }
  static _setDefaultMaxInflation(t) {
    O(typeof t == "number" && Number.isInteger(t), "invalid defaultMaxInflation factor", "value", t), qh = t;
  }
  /**
  ...
  static getBuiltinCallException(t, e, r) {
    return kb(t, e, r, vl.defaultAbiCoder());
  }
};
$r = /* @__PURE__ */ new WeakSet(), Js = function(n) {
  if (n.isArray())
    return new jm(F(this, $r, Js).call(this, n.arrayChildren), n.arrayLength, n.name);
  if (n.isTuple())
    return new la(n.components.map((e) => F(this, $r, Js).call(this, e)), n.name);
  switch (n.baseType) {
    case "address":
      return new Vm(n.name);
    case "bool":
      return new Wm(n.name);
    case "string":
      return new tw(n.name);
    case "bytes":
      return new zm(n.name);
    case "":
      return new Km(n.name);
  }
  let t = n.type.match(Bb);
  if (t) {
    let e = parseInt(t[2] || "256");
    return O(e !== 0 && e <= 256 && e % 8 === 0, "invalid " + t[1] + " bit length", "param", n), new Xm(e / 8, t[1] === "int", n.name);
  }
  if (t = n.type.match(Ob), t) {
    let e = parseInt(t[1]);
    return O(e !== 0 && e <= 32, "invalid bytes length", "param", n), new Qm(e, n.name);
  }
  O(!1, "invalid type", "type", n.type);
};
let Co = Sb;
function xl(n) {
  const t = Ve(n);
    ...
    A(this, Qt, this.getAbiCoder()), this.fragments.forEach((o, c) => {
      ...
      switch (o.type) {
        case "constructor":
          ...
          return;
        case "fallback":
          o.inputs.length === 0 ? i = !0 : (O(!s || o.payable !== s.payable, "conflicting fallback fragments", `fragments[${c}]`, o), s = o, i = s.payable);
          return;
        case "function":
          a = f(this, En);
          break;
  ...
  getError(t, e) {
    ...
    if (t.indexOf("(") === -1) {
      ...
      if (r.length > 1) {
        ...
        O(!1, `ambiguous error description (i.e. ${s})`, "name", t);
      }
      return r[0];
    }
  ...
  */
  ...
  decodeErrorResult(t, e) {
    if (typeof t == "string") {
      ...
      O(r, "unknown error", "fragment", t), t = r;
    }
    return O(Nt(e, 0, 4) === t.selector, `data signature does not match error ${t.name}.`, "data", e), this._decodeParams(t.inputs, Nt(e, 4));
  }
  /**
  ...
  decodeFunctionData(t, e) {
    if (typeof t == "string") {
      ...
      O(r, "unknown function", "fragment", t), t = r;
    }
    return O(Nt(e, 0, 4) === t.selector, `data signature does not match function ${t.name}.`, "data", e), this._decodeParams(t.inputs, Nt(e, 4));
  }
  /**
  ...
  decodeFunctionResult(t, e) {
    if (typeof t == "string") {
      ...
      O(i, "unknown function", "fragment", t), t = i;
    }
  ...
  makeError(t, e) {
    const r = tt(t, "data"), s = Co.getBuiltinCallException("call", e, r);
  ...
  */
  ...
  encodeFilterTopics(t, e) {
    if (typeof t == "string") {
      ...
      O(i, "unknown event", "eventFragment", t), t = i;
    }
    ...
    const s = (i, o) => i.type === "string" ? ss(o) : i.type === "bytes" ? Ot(W(o)) : (i.type === "bool" && typeof o == "boolean" ? o = o ? "0x01" : "0x00" : i.type.match(/^u?int/) ? o = ur(o) : i.type.match(/^bytes/) ? o = nu(o, 32) : i.type === "address" && f(this, Qt).encode(["address"], [o]), sn(W(o), 32));
    for (e.forEach((i, o) => {
      const c = t.inputs[o];
      if (!c.indexed) {
        O(i == null, "cannot filter non-indexed parameters; must be null", "contract." + c.name, i);
        return;
      }
      i == null ? r.push(null) : c.baseType === "array" || c.baseType === "tuple" ? O(!1, "filtering with tuples or arrays not supported", "contract." + c.name, i) : Array.isArray(i) ? r.push(i.map((a) => s(c, a))) : r.push(s(c, i));
  ...
  encodeEventLog(t, e) {
    if (typeof t == "string") {
      ...
      O(o, "unknown event", "eventFragment", t), t = o;
    }
    const r = [], s = [], i = [];
    return t.anonymous || r.push(t.topicHash), O(e.length === t.inputs.length, "event arguments/values mismatch", "values", e), t.inputs.forEach((o, c) => {
      const a = e[c];
      if (o.indexed)
        if (o.type === "string")
          r.push(ss(a));
  ...
  decodeEventLog(t, e, r) {
    if (typeof t == "string") {
      ...
      O(b, "unknown event", "eventFragment", t), t = b;
    }
    if (r != null && !t.anonymous) {
      const b = t.topicHash;
      O(gt(r[0], 32) && r[0].toLowerCase() === b, "fragment/topic mismatch", "topics[0]", r[0]), r = r.slice(1);
    }
    const s = [], i = [], o = [];
    ...
    const c = r != null ? f(this, Qt).decode(s, xt(r)) : null, a = f(this, Qt).decode(i, e, !0), l = [], h = [];
    let u = 0, p = 0;
   ...
   */
  parseTransaction(t) {
    const e = tt(t.data, "tx.data"), r = z(t.value != null ? t.value : 0, "tx.value"), s = this.getFunction(W(e.slice(0, 4)));
    if (!s)
      return null;
    const i = f(this, Qt).decode(s.inputs, e.slice(4));
    return new Rb(s, s.selector, i, r);
  }
  parseCallResult(t) {
    throw new Error("@TODO");
  }
  ...
  parseLog(t) {
    ...
    return !e || e.anonymous ? null : new Tb(e, e.topicHash, this.decodeEventLog(e, t.data, t.topics));
  }
  /**
   ...
   */
  parseError(t) {
    const e = W(t), r = this.getError(Nt(e, 0, 4));
    if (!r)
      return null;
    const s = f(this, Qt).decode(r.inputs, Nt(e, 4));
    return new Cb(r, r.selector, s);
  }
  /**
...
ya = function(n, t, e) {
  ...
  if (n.indexOf("(") === -1) {
    ...
    if (t) {
      ...
      let i = t.length, o = !0;
      ce.isTyped(s) && s.type === "overrides" && (o = !1, i--);
    ...
    if (r.length > 1 && e) {
      const s = r.map((i) => JSON.stringify(i.format())).join(", ");
      O(!1, `ambiguous function description (i.e. matches ${s})`, "key", n);
    }
    return r[0];
  }
...
ma = function(n, t, e) {
  ...
  if (n.indexOf("(") === -1) {
    ...
    if (t) {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        ...
        for (let o = 0; o < t.length; o++)
          if (ce.isTyped(t[o]) && t[o].type !== i[o].baseType) {
            r.splice(s, 1);
            break;
          }
      }
    ...
    if (r.length > 1 && e) {
      const s = r.map((i) => JSON.stringify(i.format())).join(", ");
      O(!1, `ambiguous event description (i.e. matches ${s})`, "key", n);
    }
    return r[0];
  }
...
function rc(n) {
  ...
  for (const s of r)
    !(s in n) || n[s] == null || (t[s] = et(n[s], `request.${s}`));
...
class Ub {
  ...
  toJSON() {
    ...
    return {
      ...
      gasLimit: Bt(s),
      gasUsed: Bt(i),
      blobGasUsed: Bt(this.blobGasUsed),
      excessBlobGas: Bt(this.excessBlobGas),
      hash: o,
      miner: c,
      prevRandao: a,
      nonce: l,
...
class Up {
  ...
  toJSON() {
    ...
    return {
      ...
      //byzantium, 
      contractAddress: r,
      cumulativeGasUsed: Bt(this.cumulativeGasUsed),
      from: e,
      gasPrice: Bt(this.gasPrice),
      blobGasUsed: Bt(this.blobGasUsed),
      blobGasPrice: Bt(this.blobGasPrice),
      gasUsed: Bt(this.gasUsed),
      hash: s,
      index: i,
      logs: l,
      logsBloom: a,
   ...
   */
  reorderedEvent(t) {
    return D(!t || t.isMined(), "unmined 'other' transction cannot be orphaned", "UNSUPPORTED_OPERATION", { operation: "reorderedEvent(other)" }), Dp(this, t);
  }
}
...
const Lb = class Lp {
  ...
  toJSON() {
    ...
    return {
      ...
      chainId: Bt(this.chainId),
      data: l,
      from: c,
      gasLimit: Bt(this.gasLimit),
      gasPrice: Bt(this.gasPrice),
      hash: s,
      maxFeePerGas: Bt(this.maxFeePerGas),
      maxPriorityFeePerGas: Bt(this.maxPriorityFeePerGas),
      maxFeePerBlobGas: Bt(this.maxFeePerBlobGas),
      nonce: a,
      signature: h,
      to: o,
      index: r,
  ...
  async wait(t, e) {
          ...
          for (let d = 0; d < y.length; d++) {
            ...
            if (g.from === this.from && g.nonce === this.nonce) {
              ...
              if (w == null || u - w.blockNumber + 1 < r)
                return;
              let I = "replaced";
              g.data === this.data && g.to === this.to && g.value === this.value ? I = "repriced" : g.data === "0x" && g.from === g.to && g.value === Pp && (I = "cancelled"), D(!1, "transaction was replaced", "TRANSACTION_REPLACED", {
    ...
    return await new Promise((u, p) => {
      ...
      if (b.push(() => {
        ...
        const g = setTimeout(() => {
          y(), p(It("wait for transaction timeout", "TIMEOUT"));
        }, s);
        b.push(() => {
          clearTimeout(g);
        });
   ...
   */
  removedEvent() {
    return D(this.isMined(), "unmined transaction canot be orphaned", "UNSUPPORTED_OPERATION", { operation: "removeEvent()" }), Fp(this);
  }
  /**
   *  Returns a filter which can be used to listen for orphan events
   ...
   */
  reorderedEvent(t) {
    return D(this.isMined(), "unmined transaction canot be orphaned", "UNSUPPORTED_OPERATION", { operation: "removeEvent()" }), D(!t || t.isMined(), "unmined 'other' transaction canot be orphaned", "UNSUPPORTED_OPERATION", { operation: "removeEvent()" }), Dp(this, t);
  }
  /**
  ...
  replaceableTransaction(t) {
    O(Number.isInteger(t) && t >= 0, "invalid startBlock", "startBlock", t);
    const e = new Lp(this, this.provider);
    return A(e, Ar, t), e;
  }
};
...
let Eu = class extends bu {
  ...
  async wait(t, e) {
    ...
    return r == null ? null : new Mb(f(this, ba), this.provider, r);
  }
};
...
async function jp(n, t) {
  const e = ce.dereference(n, "overrides");
  O(typeof e == "object", "invalid overrides parameter", "overrides", n);
  const r = rc(e);
  return O(r.to == null || (t || []).indexOf("to") >= 0, "cannot override to", "overrides.to", r.to), O(r.data == null || (t || []).indexOf("data") >= 0, "cannot override data", "overrides.data", r.data), r.from && (r.from = r.from), r;
}
async function Gb(n, t, e) {
  const r = as(n, "resolveName"), s = sc(r) ? r : null;
  return await Promise.all(t.map((i, o) => i.walkAsync(e[o], (c, a) => (a = ce.dereference(a, c), c === "address" ? te(a, s) : a))));
}
function Vb(n) {
  const t = async function(o) {
    const c = await jp(o, ["data"]);
    c.to = await n.getAddress(), c.from && (c.from = await te(c.from, $p(n.runner)));
    const a = n.interface, l = z(c.value || Xh, "overrides.value") === Xh, h = (c.data || "0x") === "0x";
    a.fallback && !a.fallback.payable && a.receive && !h && !l && O(!1, "cannot send data to receive or send value to non-payable fallback", "overrides", o), O(a.fallback || h, "cannot send data to receive-only contract", "overrides.data", c.data);
    const u = a.receive || a.fallback && a.fallback.payable;
    return O(u || l, "cannot send value to non-payable fallback", "overrides.value", c.value), O(a.fallback || h, "cannot send data to receive-only contract", "overrides.data", c.data), c;
  }, e = async function(o) {
    const c = as(n.runner, "call");
    D(_p(c), "contract runner does not support calling", "UNSUPPORTED_OPERATION", { operation: "call" });
    const a = await t(o);
    try {
    ...
    const c = n.runner;
    D(Vp(c), "contract runner does not support sending transactions", "UNSUPPORTED_OPERATION", { operation: "sendTransaction" });
    const a = await c.sendTransaction(await t(o)), l = jr(n.runner);
    return new Eu(n.interface, l, a);
  }, s = async function(o) {
    const c = as(n.runner, "estimateGas");
    return D(Gp(c), "contract runner does not support gas estimation", "UNSUPPORTED_OPERATION", { operation: "estimateGas" }), await c.estimateGas(await t(o));
  }, i = async (o) => await r(o);
  return q(i, {
    _contract: n,
    estimateGas: s,
...
function $b(n, t) {
  const e = function(...l) {
    ...
    const h = e(...l);
    let u = {};
    if (h.inputs.length + 1 === l.length && (u = await jp(l.pop()), u.from && (u.from = await te(u.from, $p(n.runner)))), h.inputs.length !== l.length)
      throw new Error("internal error: fragment inputs doesn't match arguments; should not happen");
    const p = await Gb(n.runner, h.inputs, l);
    ...
    const h = n.runner;
    D(Vp(h), "contract runner does not support sending transactions", "UNSUPPORTED_OPERATION", { operation: "sendTransaction" });
    const u = await h.sendTransaction(await r(...l)), p = jr(n.runner);
    return new Eu(n.interface, p, u);
  }, o = async function(...l) {
    const h = as(n.runner, "estimateGas");
    return D(Gp(h), "contract runner does not support gas estimation", "UNSUPPORTED_OPERATION", { operation: "estimateGas" }), await h.estimateGas(await r(...l));
  }, c = async function(...l) {
    const h = as(n.runner, "call");
    D(_p(h), "contract runner does not support calling", "UNSUPPORTED_OPERATION", { operation: "call" });
    const u = await r(...l);
    let p = "0x";
    try {
      p = await h.call(u);
...
const ic = Symbol.for("_ethersInternal_contract"), Wp = /* @__PURE__ */ new WeakMap();
function Wb(n, t) {
  Wp.set(n[ic], t);
}
function he(n) {
...
async function vu(n, t) {
  ...
  if (Array.isArray(t)) {
    const i = function(o) {
      ...
      return O(c, "unknown fragment", "name", o), c.topicHash;
    };
    e = t.map((o) => o == null ? null : Array.isArray(o) ? o.map(i) : i(o));
  } else t === "*" ? e = [null] : typeof t == "string" ? gt(t, 32) ? e = [t] : (r = n.interface.getEvent(t), O(r, "unknown fragment", "event", t), e = [r.topicHash]) : zb(t) ? e = await t.getTopicFilter() : "fragment" in t ? (r = t.fragment, e = [r.topicHash]) : O(!1, "unknown event name", "event", t);
  e = e.map((i) => {
    if (i == null)
      return null;
    if (Array.isArray(i)) {
...
async function tf(n, t, e) {
  ...
  const { fragment: s, tag: i, topics: o } = await vu(n, e), { addr: c, subs: a } = he(n);
  let l = a.get(i);
  if (!l) {
    const h = { address: c || n, topics: o }, u = (b) => {
      ...
      if (y) {
        ...
        Nl(n, e, g, (w) => new Hb(n, w, e, d, b));
      } else
        Nl(n, e, [], (d) => new Hp(n, d, e, b));
    };
    let p = [];
...
async function Qb(n, t, e, r) {
  ...
  return s.listeners = s.listeners.filter(({ listener: o, once: c }) => {
    ...
    return !c;
  }), s.listeners.length === 0 && (s.stop(), he(n).subs.delete(s.tag)), i > 0;
}
...
const qb = class Ea {
   ...
   */
  constructor(t, e, r, s) {
    S(this, "target"), S(this, "interface"), S(this, "runner"), S(this, "filters"), S(this, zp), S(this, "fallback"), O(typeof t == "string" || Wd(t), "invalid value for Contract target", "target", t), r == null && (r = null);
    const i = Ss.from(e);
    ...
    if (typeof t == "string")
      if (gt(t))
        ...
        if (!sc(u))
          throw It("contract runner does not support name resolution", "UNSUPPORTED_OPERATION", {
      ...
      o = t.getAddress().then((u) => {
        if (u == null)
          throw new Error("TODO");
        return he(this).addr = u, u;
      });
    Wb(this, { addrPromise: o, addr: c, deployTx: a, subs: l });
    const h = new Proxy({}, {
      get: (u, p, b) => {
    ...
    return q(this, { filters: h }), q(this, {
      fallback: i.receive || i.fallback ? Vb(this) : null
    }), new Proxy(this, {
      get: (u, p, b) => {
   ...
   */
  async getAddress() {
    return await he(this).addrPromise;
  }
  /**
   ...
   */
  getFunction(t) {
    return typeof t != "string" && (t = t.format()), $b(this, t);
  }
  /**
   ...
   */
  getEvent(t) {
    return typeof t != "string" && (t = t.format()), jb(this, t);
  }
  /**
   *  @_ignore:
   */
  ...
  async queryFilter(t, e, r) {
    ...
    const { addr: s, addrPromise: i } = he(this), o = s || await i, { fragment: c, topics: a } = await vu(this, t), l = { address: o, topics: a, fromBlock: e, toBlock: r }, h = jr(this.runner);
  ...
  async off(t, e) {
    ...
    return (e == null || r.listeners.length === 0) && (r.stop(), he(this).subs.delete(r.tag)), this;
  }
  /**
  ...
  async removeAllListeners(t) {
    if (t) {
      ...
      if (!e)
        return this;
      e.stop(), he(this).subs.delete(e.tag);
    } else {
      const { subs: e } = he(this);
...
function Sc(n) {
  return n.match(/^ipfs:\/\/ipfs\//i) ? n = n.substring(12) : n.match(/^ipfs:\/\//i) ? n = n.substring(7) : O(!1, "unsupported IPFS format", "link", n), `https://gateway.ipfs.io/ipfs/${n}`;
}
class Zb {
  /**
...
const Bl = class kl {
  ...
  async getAddress(t) {
    ...
    for (const i of this.provider.plugins)
      if (i instanceof Zb && i.supportsCoinType(t)) {
        e = i;
        break;
      }
    if (e == null)
      ...
      for (let r = 0; r < ef.length; r++) {
        ...
        switch (i) {
          ...
          case "erc1155": {
            ...
            t.push({ type: "metadata-url-base", value: u }), i === "erc1155" && (u = u.replace("{id}", ur(l, 32).substring(2)), t.push({ type: "metadata-url-expanded", value: u })), u.match(/^ipfs:/i) && (u = Sc(u)), t.push({ type: "metadata-url", value: u });
            let p = {};
  ...
  static async fromName(t, e) {
    ...
    for (; ; ) {
      if (s === "" || s === "." || e !== "eth" && s === "eth")
        return null;
      const i = await F(r = kl, Ol, qp).call(r, t, s);
      if (i != null) {
...
Er = /* @__PURE__ */ new WeakMap(), Ys = /* @__PURE__ */ new WeakMap(), vr = /* @__PURE__ */ new WeakSet(), Ts = async function(n, t) {
  ...
  return null;
}, Ol = /* @__PURE__ */ new WeakSet(), qp = async function(n, t) {
  const e = await Bl.getEnsAddress(n);
  try {
...
function Yb(n) {
  ...
  O(!1, `invalid boolean; ${JSON.stringify(n)}`, "value", n);
}
function ci(n) {
  return O(gt(n, !0), "invalid data", "value", n), n;
}
function Gt(n) {
  return O(gt(n, 32), "invalid hash", "value", n), n;
}
const Xb = _o({
  address: ft,
  blockHash: Gt,
...
const eA = _o({
  hash: it(Gt),
  parentHash: Gt,
  parentBeaconBlockRoot: it(Gt, null),
  number: et,
  timestamp: et,
  nonce: it(ci),
  difficulty: z,
  gasLimit: z,
  gasUsed: z,
  stateRoot: it(Gt, null),
  receiptsRoot: it(Gt, null),
  blobGasUsed: it(z, null),
  excessBlobGas: it(z, null),
  miner: it(ft),
  prevRandao: it(Gt, null),
  extraData: ci,
  baseFeePerGas: it(z)
}, {
  prevRandao: ["mixHash"]
...
function nA(n) {
  const t = eA(n);
  return t.transactions = n.transactions.map((e) => typeof e == "string" ? e : Kp(e)), t;
}
const rA = _o({
  transactionIndex: et,
  blockNumber: et,
...
const iA = _o({
  ...
  cumulativeGasUsed: z,
  effectiveGasPrice: it(z),
  blobGasPrice: it(z, null),
  status: it(et),
  type: it(et, 0)
}, {
...
function Kp(n) {
  ...
  const t = _o({
    ...
    index: it(et, void 0),
    type: (e) => e === "0x" || e == null ? 0 : et(e),
    accessList: it(fs, null),
    blobVersionedHashes: it(oc(Gt, !0), null),
    blockHash: it(Gt, null),
    blockNumber: it(et, null),
    transactionIndex: it(et, null),
    from: ft,
    // either (gasPrice) or (maxPriorityFeePerGas + maxFeePerGas) must be set
    gasPrice: it(z),
    maxPriorityFeePerGas: it(z),
    maxFeePerGas: it(z),
    maxFeePerBlobGas: it(z, null),
    gasLimit: z,
    to: it(ft, null),
    value: z,
    nonce: et,
  ...
  if (t.to == null && t.creates == null && (t.creates = _m(t)), (n.type === 1 || n.type === 2) && n.accessList == null && (t.accessList = []), n.signature ? t.signature = an.from(n.signature) : t.signature = an.from(n), t.chainId == null) {
    const e = t.signature.legacyChainId;
    e != null && (t.chainId = e);
  }
  return t.blockHash && z(t.blockHash) === rf && (t.blockHash = null), t;
}
const aA = "0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e";
class Go {
  /**
...
class ac extends Go {
  ...
  constructor(t, e) {
    ...
    function s(i, o) {
      let c = (e || {})[i];
      c == null && (c = o), O(typeof c == "number", `invalud value for ${i}`, "costs", e), r[i] = c;
    }
...
const lA = class so {
  ...
  static from(t) {
    ...
    if (typeof t.clone == "function")
      return t.clone();
    if (typeof t == "object") {
      O(typeof t.name == "string" && typeof t.chainId == "number", "invalid network object name or chainId", "network", t);
  ...
  static register(t, e) {
    ...
    const r = Tc.get(t);
    r && O(!1, `conflicting network for ${JSON.stringify(r.name)}`, "nameOrChainId", t), Tc.set(t, e);
  }
};
...
function uA() {
  ...
  function n(t, e, r) {
    ...
    cr.register(t, s), cr.register(e, s), r.altNames && r.altNames.forEach((i) => {
      cr.register(i, s);
    });
  }
...
var lr, Me, Pr, yn, bo, $a;
class hA {
  /**
   *  Create a new **PollingBlockSubscriber** attached to %%provider%%.
   */
  constructor(t) {
    C(this, bo), C(this, lr), C(this, Me), C(this, Pr), C(this, yn), A(this, lr, t), A(this, Me, null), A(this, Pr, 4e3), A(this, yn, -2);
  }
  /**
  ...
  start() {
    f(this, Me) || (A(this, Me, f(this, lr)._setTimeout(F(this, bo, $a).bind(this), f(this, Pr))), F(this, bo, $a).call(this));
  }
  stop() {
    f(this, Me) && (f(this, lr)._clearTimeout(f(this, Me)), A(this, Me, null));
  }
  pause(t) {
...
lr = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), Pr = /* @__PURE__ */ new WeakMap(), yn = /* @__PURE__ */ new WeakMap(), bo = /* @__PURE__ */ new WeakSet(), $a = async function() {
  try {
    const n = await f(this, lr).getBlockNumber();
    if (f(this, yn) === -2) {
      A(this, yn, n);
      return;
    }
    if (n !== f(this, yn)) {
      for (let t = f(this, yn) + 1; t <= n; t++) {
        if (f(this, Me) == null)
          return;
        await f(this, lr).emit("block", t);
      }
      A(this, yn, n);
    }
  } catch {
  }
  f(this, Me) != null && A(this, Me, f(this, lr)._setTimeout(F(this, bo, $a).bind(this), f(this, Pr)));
};
var Rs, Cs, Ir;
let Iu = class {
  /**
...
let Nu = class {
   ...
   */
  constructor(t, e) {
    C(this, Tl), C(this, ir), C(this, Ao), C(this, ao), C(this, Nr), C(this, He), A(this, ir, t), A(this, Ao, xu(e)), A(this, ao, F(this, Tl, Jp).bind(this)), A(this, Nr, !1), A(this, He, -2);
  }
  start() {
    f(this, Nr) || (A(this, Nr, !0), f(this, He) === -2 && f(this, ir).getBlockNumber().then((t) => {
      A(this, He, t);
    }), f(this, ir).on("block", f(this, ao)));
  }
  stop() {
    f(this, Nr) && (A(this, Nr, !1), f(this, ir).off("block", f(this, ao)));
  }
  pause(t) {
    this.stop(), t && A(this, He, -2);
  }
  resume() {
    this.start();
  }
};
ir = /* @__PURE__ */ new WeakMap(), Ao = /* @__PURE__ */ new WeakMap(), ao = /* @__PURE__ */ new WeakMap(), Nr = /* @__PURE__ */ new WeakMap(), He = /* @__PURE__ */ new WeakMap(), Tl = /* @__PURE__ */ new WeakSet(), Jp = async function(n) {
  if (f(this, He) === -2)
    return;
  const t = xu(f(this, Ao));
  t.fromBlock = f(this, He) + 1, t.toBlock = n;
  const e = await f(this, ir).getLogs(t);
  if (e.length === 0) {
    f(this, He) < n - 60 && A(this, He, n - 60);
    return;
  }
  for (const r of e)
    f(this, ir).emit(f(this, Ao), r), A(this, He, r.blockNumber);
};
const gA = BigInt(2), yA = 10;
function ea(n) {
...
async function Rc(n, t) {
  ...
  if (n.orphan) {
    const e = n;
    return { type: "orphan", tag: Ia("orphan", e), filter: mA(e) };
  }
  ...
  O(!1, "unknown ProviderEvent", "event", n);
}
function Cc() {
  return (/* @__PURE__ */ new Date()).getTime();
}
...
var Jt, Or, qt, co, Ae, Ps, Ur, er, Na, Re, lo, Eo, ut, fe, Cl, Pl, uo, Ul, ho, Oa;
class bA {
  /**
   ...
   */
  constructor(t, e) {
    if (C(this, ut), C(this, Jt), C(this, Or), C(this, qt), C(this, co), C(this, Ae), C(this, Ps), C(this, Ur), C(this, er), C(this, Na), C(this, Re), C(this, lo), C(this, Eo), A(this, Eo, Object.assign({}, wA, e || {})), t === "any")
      A(this, Ps, !0), A(this, Ae, null);
    else if (t) {
      const r = cr.from(t);
      A(this, Ps, !1), A(this, Ae, Promise.resolve(r)), setTimeout(() => {
        this.emit("network", r, null);
      }, 0);
    } else
      A(this, Ps, !1), A(this, Ae, null);
    A(this, er, -1), A(this, Ur, /* @__PURE__ */ new Map()), A(this, Jt, /* @__PURE__ */ new Map()), A(this, Or, /* @__PURE__ */ new Map()), A(this, qt, null), A(this, co, !1), A(this, Na, 1), A(this, Re, /* @__PURE__ */ new Map()), A(this, lo, !1);
  }
  get pollingInterval() {
   ...
   */
  get plugins() {
    return Array.from(f(this, Or).values());
  }
  /**
   *  Attach a new plug-in.
   */
  attachPlugin(t) {
    if (f(this, Or).get(t.name))
      throw new Error(`cannot replace existing plugin: ${t.name} `);
    return f(this, Or).set(t.name, t.connect(this)), this;
  }
  /**
   *  Get a plugin by name.
   */
  getPlugin(t) {
    return f(this, Or).get(t) || null;
  }
  /**
  ...
  async getBlockNumber() {
    const t = et(await F(this, ut, fe).call(this, { method: "getBlockNumber" }), "%response");
  ...
  _getBlockTag(t) {
    ...
    if (typeof t == "bigint" && (t = et(t, "blockTag")), typeof t == "number")
      return t >= 0 ? Hs(t) : f(this, er) >= 0 ? Hs(f(this, er) + t) : this.getBlockNumber().then((e) => Hs(e + t));
    O(!1, "invalid blockTag", "blockTag", t);
  }
  /**
    ...
    if (f(this, Ae) == null) {
      const s = (async () => {
        try {
          ...
          throw f(this, Ae) === s && A(this, Ae, null), i;
        }
      })();
      return A(this, Ae, s), (await s).clone();
    }
    const t = f(this, Ae), [e, r] = await Promise.all([
      t,
      this._detectNetwork()
      // The actual connected network
    ]);
    return e.chainId !== r.chainId && (f(this, Ps) ? (this.emit("network", r, e), f(this, Ae) === t && A(this, Ae, Promise.resolve(r))) : D(!1, `network changed: ${e.chainId} => ${r.chainId} `, "NETWORK_ERROR", {
      event: "changed"
    })), e.clone();
  }
  async getFeeData() {
    const t = await this.getNetwork(), e = async () => {
      const { _block: s, gasPrice: i, priorityFee: o } = await Zt({
        ...
        gasPrice: (async () => {
          try {
            const h = await F(this, ut, fe).call(this, { method: "getGasPrice" });
            return z(h, "%response");
          } catch {
          }
          return null;
        ...
        priorityFee: (async () => {
          try {
            const h = await F(this, ut, fe).call(this, { method: "getPriorityFee" });
            return z(h, "%response");
          } catch {
          }
          return null;
      ...
      return l && l.baseFeePerGas && (a = o ?? BigInt("1000000000"), c = l.baseFeePerGas * gA + a), new Yh(i, c, a);
  ...
  async estimateGas(t) {
    ...
    return ea(e) && (e = await e), z(await F(this, ut, fe).call(this, {
      method: "estimateGas",
      transaction: e
    }), "%response");
  }
  ...
  async getTransactionCount(t, e) {
    return et(await F(this, ut, uo).call(this, { method: "getTransactionCount" }, t, e), "%response");
  }
  async getCode(t, e) {
  ...
  async getTransaction(t) {
    const { network: e, params: r } = await Zt({
      network: this.getNetwork(),
      params: F(this, ut, fe).call(this, { method: "getTransaction", hash: t })
    });
  ...
  async getTransactionReceipt(t) {
    const { network: e, params: r } = await Zt({
      network: this.getNetwork(),
      params: F(this, ut, fe).call(this, { method: "getTransactionReceipt", hash: t })
    });
    if (r == null)
      return null;
    if (r.gasPrice == null && r.effectiveGasPrice == null) {
      const s = await F(this, ut, fe).call(this, { method: "getTransaction", hash: t });
      if (s == null)
  ...
  async getTransactionResult(t) {
    const { result: e } = await Zt({
      network: this.getNetwork(),
      result: F(this, ut, fe).call(this, { method: "getTransactionResult", hash: t })
    });
  ...
  async getLogs(t) {
    ...
    const { network: r, params: s } = await Zt({
      network: this.getNetwork(),
      params: F(this, ut, fe).call(this, { method: "getLogs", filter: e })
    });
  ...
  async waitForTransaction(t, e, r) {
    ...
    return s === 0 ? this.getTransactionReceipt(t) : new Promise(async (i, o) => {
      ...
      r != null && (c = setTimeout(() => {
        c != null && (c = null, this.off("block", a), o(It("timeout", "TIMEOUT", { reason: "timeout" })));
   ...
   */
  _clearTimeout(t) {
    const e = f(this, Re).get(t);
    e && (e.timer && clearTimeout(e.timer), f(this, Re).delete(t));
  }
  /**
  ...
  _setTimeout(t, e) {
    ...
    const r = Ca(this, Na)._++, s = () => {
      f(this, Re).delete(r), t();
    };
    if (this.paused)
      f(this, Re).set(r, { timer: null, func: s, time: e });
    else {
      const i = setTimeout(s, e);
      f(this, Re).set(r, { timer: i, func: s, time: Cc() });
    }
    return r;
  }
  /**
  ...
  _getSubscriber(t) {
    switch (t.type) {
      ...
      case "safe":
      case "finalized":
        return new fA(this, t.type);
      case "event":
        return new Nu(this, t.filter);
      case "transaction":
        return new pA(this, t.hash);
      case "orphan":
  ...
  async on(t, e) {
    const r = await F(this, ut, Oa).call(this, t);
  ...
  async emit(t, ...e) {
    ...
    return r.listeners = r.listeners.filter(({ listener: i, once: o }) => {
      const c = new ed(this, o ? null : i, t);
      try {
        i.call(this, ...e, c);
      } catch {
      }
  ...
  async removeAllListeners(t) {
    if (t) {
      const { tag: e, started: r, subscriber: s } = await F(this, ut, Oa).call(this, t);
  ...
  pause(t) {
    ...
    for (const e of f(this, Re).values())
  ...
  resume() {
    if (f(this, qt) != null) {
      ...
      for (const t of f(this, Re).values()) {
        let e = t.time;
...
Jt = /* @__PURE__ */ new WeakMap(), Or = /* @__PURE__ */ new WeakMap(), qt = /* @__PURE__ */ new WeakMap(), co = /* @__PURE__ */ new WeakMap(), Ae = /* @__PURE__ */ new WeakMap(), Ps = /* @__PURE__ */ new WeakMap(), Ur = /* @__PURE__ */ new WeakMap(), er = /* @__PURE__ */ new WeakMap(), Na = /* @__PURE__ */ new WeakMap(), Re = /* @__PURE__ */ new WeakMap(), lo = /* @__PURE__ */ new WeakMap(), Eo = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakSet(), fe = async function(n) {
  ...
  D(e < yA, "CCIP read exceeded maximum redirections", "OFFCHAIN_FAULT", {
  ...
  try {
    ...
    if (!this.disableCcipRead && tu(s) && s.data && e >= 0 && t === "latest" && r.to != null && Nt(s.data, 0, 4) === "0x556f1830") {
      ...
      const l = {
        to: o,
        data: xt([c.selector, xA([a, c.extraData])])
      };
  ...
  return (typeof r != "string" || typeof s != "string") && ([r, s] = await Promise.all([r, s])), await F(this, ut, Pl).call(this, F(this, ut, fe).call(this, Object.assign(n, { address: r, blockTag: s })));
}, Ul = async function(n, t) {
  if (gt(n, 32))
    return await F(this, ut, fe).call(this, {
      method: "getBlock",
      blockHash: n,
      includeTransactions: t
    });
  let e = this._getBlockTag(n);
  return typeof e != "string" && (e = await e), await F(this, ut, fe).call(this, {
    method: "getBlock",
    blockTag: e,
    includeTransactions: t
  });
...
function Ll(n, t) {
  if (n === "0x")
    return null;
  try {
    const e = et(Nt(n, t, t + 32)), r = et(Nt(n, e, e + 32));
    return Nt(n, e + 32, e + 32 + r);
  } catch {
  }
  return null;
}
...
function xA(n) {
  ...
  for (let r = 0; r < n.length; r++) {
    const s = tt(n[r]);
    t[r] = cf(e), t.push(cf(s.length)), t.push(EA(s)), e += 32 + Math.ceil(s.length / 32) * 32;
  }
  return xt(t);
}
...
function IA(n) {
  ...
  const e = Nt(n, 0, 32);
  D(Nt(e, 0, 12) === Nt(lf, 0, 12), "corrupt OffchainLookup sender", "OFFCHAIN_FAULT", {
    reason: "corrupt OffchainLookup sender"
  }), t.sender = Nt(e, 12);
  try {
    const r = [], s = et(Nt(n, 32, 64)), i = et(Nt(n, s, s + 32)), o = Nt(n, s + 32);
    for (let c = 0; c < i; c++) {
      const a = AA(o, c * 32);
      if (a == null)
  ...
  D(Nt(n, 100, 128) === Nt(lf, 0, 28), "corrupt OffchainLookup callbaackSelector", "OFFCHAIN_FAULT", {
    reason: "corrupt OffchainLookup callbaackSelector"
  }), t.selector = Nt(n, 96, 100);
  try {
    const r = Ll(n, 128);
    if (r == null)
      throw new Error("abort");
...
async function uf(n, t) {
  ...
  if (e.to != null && (e.to = te(e.to, n)), e.from != null) {
    ...
    e.from = Promise.all([
      n.getAddress(),
      te(r, n)
    ]).then(([s, i]) => (O(s.toLowerCase() === i.toLowerCase(), "transaction from mismatch", "tx.from", i), s));
  } else
    e.from = n.getAddress();
  return await Zt(e);
}
class Yp {
  ...
  async populateTransaction(t) {
    ...
    if (r.chainId != null) {
      const o = z(r.chainId);
      O(o === s.chainId, "transaction chainId mismatch", "tx.chainId", t.chainId);
    } else
      r.chainId = s.chainId;
    const i = r.maxFeePerGas != null || r.maxPriorityFeePerGas != null;
    if (r.gasPrice != null && (r.type === 2 || i) ? O(!1, "eip-1559 transaction do not support gasPrice", "tx", t) : (r.type === 0 || r.type === 1) && i && O(!1, "pre-eip-1559 transaction do not support maxFeePerGas/maxPriorityFeePerGas", "tx", t), (r.type === 2 || r.type == null) && r.maxFeePerGas != null && r.maxPriorityFeePerGas != null)
      r.type = 2;
...
const NA = class Xp extends Yp {
  ...
  connect(t) {
    return new Xp(this.address, t);
  }
  async signTransaction(t) {
    F(this, fo, Ba).call(this, "transactions", "signTransaction");
  }
  async signMessage(t) {
    F(this, fo, Ba).call(this, "messages", "signMessage");
  }
  async signTypedData(t, e, r) {
    F(this, fo, Ba).call(this, "typed-data", "signTypedData");
  }
};
fo = /* @__PURE__ */ new WeakSet(), Ba = function(n, t) {
...
class tg {
   ...
   */
  constructor(t) {
    C(this, Us), C(this, se), C(this, pn), C(this, Vs), C(this, Br), C(this, $s), C(this, vo), A(this, se, t), A(this, pn, null), A(this, Vs, F(this, Us, Dl).bind(this)), A(this, Br, !1), A(this, $s, null), A(this, vo, !1);
  }
  /**
  ...
  start() {
    f(this, Br) || (A(this, Br, !0), F(this, Us, Dl).call(this, -2));
  }
  stop() {
    f(this, Br) && (A(this, Br, !1), A(this, vo, !0), F(this, Us, Fl).call(this), f(this, se).off("block", f(this, Vs)));
  }
  pause(t) {
...
se = /* @__PURE__ */ new WeakMap(), pn = /* @__PURE__ */ new WeakMap(), Vs = /* @__PURE__ */ new WeakMap(), Br = /* @__PURE__ */ new WeakMap(), $s = /* @__PURE__ */ new WeakMap(), vo = /* @__PURE__ */ new WeakMap(), Us = /* @__PURE__ */ new WeakSet(), Dl = async function(n) {
  try {
...
class BA extends tg {
   ...
   */
  constructor(t, e) {
    super(t), C(this, Ls), A(this, Ls, OA(e));
  }
  _recover(t) {
...
const SA = "bigint,boolean,function,number,string,symbol".split(/,/g);
function ka(n) {
  if (n == null || SA.indexOf(typeof n) >= 0 || typeof n.getAddress == "function")
    return n;
  if (Array.isArray(n))
    return n.map(ka);
  if (typeof n == "object")
...
let Pc = class extends Yp {
  ...
  async sendUncheckedTransaction(t) {
    ...
    if (e.from) {
      ...
      r.push((async () => {
        ...
        O(o != null && o.toLowerCase() === this.address.toLowerCase(), "from address mismatch", "transaction", t), e.from = o;
      })());
    } else
      e.from = this.address;
    ...
    return await new Promise((s, i) => {
      ...
      const a = async () => {
        try {
          ...
          this.provider.emit("error", It("failed to fetch transation after sending (will try again)", "UNKNOWN_ERROR", { error: l }));
        }
  ...
  async signTransaction(t) {
    ...
    if (e.from) {
      ...
      O(s != null && s.toLowerCase() === this.address.toLowerCase(), "from address mismatch", "transaction", t), e.from = s;
    } else
      e.from = this.address;
  ...
  async signTypedData(t, e, r) {
    const s = ka(r), i = await Fh.resolveNames(t, e, s, async (o) => {
      const c = await te(o);
      return O(c != null, "TypedData does not support null address", "value", o), c;
    });
...
var Xs, po, or, vn, Je, Ce, ue, Sa, Ml;
class RA extends bA {
  constructor(t, e) {
    super(t, e), C(this, Sa), C(this, Xs), C(this, po), C(this, or), C(this, vn), C(this, Je), C(this, Ce), C(this, ue), A(this, po, 1), A(this, Xs, Object.assign({}, eg, e || {})), A(this, or, []), A(this, vn, null), A(this, Ce, null), A(this, ue, null);
    {
      let s = null;
    ...
    typeof r == "boolean" ? (O(!r || t !== "any", "staticNetwork cannot be used on special network 'any'", "options", e), r && t != null && A(this, Ce, cr.from(t))) : r && (O(t == null || r.matches(t), "staticNetwork MUST match network object", "options", e), A(this, Ce, r));
  }
  /**
   ...
   */
  get _network() {
    return D(f(this, Ce), "network is not available yet", "NETWORK_ERROR"), f(this, Ce);
  }
  /**
  ...
  async _detectNetwork() {
    ...
    if (t)
      if (t === !0) {
        ...
        return t;
    return f(this, ue) ? await f(this, ue) : this.ready ? (A(this, ue, (async () => {
      try {
        const e = cr.from(z(await this.send("eth_chainId", [])));
        return A(this, ue, null), e;
      } catch (e) {
        throw A(this, ue, null), e;
      }
    })()), await f(this, ue)) : (A(this, ue, (async () => {
      const e = {
        id: Ca(this, po)._++,
        method: "eth_chainId",
        params: [],
      ...
      let r;
      try {
        r = (await this._send(e))[0], A(this, ue, null);
      } catch (s) {
        throw A(this, ue, null), this.emit("debug", { action: "receiveRpcError", error: s }), s;
      }
      if (this.emit("debug", { action: "receiveRpcResult", result: r }), "result" in r)
        return cr.from(z(r.result));
  ...
  _start() {
    f(this, Je) == null || f(this, Je).resolve == null || (f(this, Je).resolve(), A(this, Je, null), (async () => {
      for (; f(this, Ce) == null && !this.destroyed; )
        try {
          A(this, Ce, await this._detectNetwork());
        } catch (t) {
          if (this.destroyed)
            break;
          console.log("JsonRpcProvider failed to detect network and cannot start up; retry in 1s (perhaps the URL is wrong or the node is not started)"), this.emit("error", It("failed to bootstrap network detection", "NETWORK_ERROR", { event: "initial-network-discovery", info: { error: t } })), await TA(1e3);
        }
   ...
   */
  _getSubscriber(t) {
    return t.type === "pending" ? new kA(this) : t.type === "event" ? this._getOption("polling") ? new Nu(this, t.filter) : new BA(this, t.filter) : t.type === "orphan" && t.filter.orphan === "drop-log" ? new Zp("orphan") : super._getSubscriber(t);
  }
  /**
  ...
  getRpcError(t, e) {
    ...
    if (r === "eth_estimateGas" && s.message) {
      ...
      if (!c.match(/revert/i) && c.match(/insufficient funds/i))
        return It("insufficient funds", "INSUFFICIENT_FUNDS", {
    ...
    if (r === "eth_sendRawTransaction" || r === "eth_sendTransaction") {
      ...
      if (i.match(/insufficient funds|base fee exceeds gas limit/i))
        return It("insufficient funds for intrinsic transaction cost", "INSUFFICIENT_FUNDS", {
          transaction: c,
          info: { error: s }
        });
      if (i.match(/nonce/i) && i.match(/too low/i))
        return It("nonce has already been used", "NONCE_EXPIRED", { transaction: c, info: { error: s } });
      if (i.match(/replacement transaction/i) && i.match(/underpriced/i))
        return It("replacement fee too low", "REPLACEMENT_UNDERPRICED", { transaction: c, info: { error: s } });
      if (i.match(/only replay-protected/i))
        return It("legacy pre-eip-155 transactions not supported", "UNSUPPORTED_OPERATION", {
          operation: r,
          info: { transaction: c, info: { error: s } }
        });
    }
    let o = !!i.match(/the method .* does not exist/i);
    return o || s && s.details && s.details.startsWith("Unauthorized method:") && (o = !0), o ? It("unsupported operation", "UNSUPPORTED_OPERATION", {
      operation: t.method,
      info: { error: s, payload: t }
    }) : It("could not coalesce error", "UNKNOWN_ERROR", { error: s, payload: t });
  }
  /**
  ...
  send(t, e) {
    if (this.destroyed)
      return Promise.reject(It("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", { operation: t }));
  ...
  destroy() {
    ...
    for (const { payload: t, reject: e } of f(this, or))
      e(It("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", { operation: t.method }));
    A(this, or, []), super.destroy();
  }
}
Xs = /* @__PURE__ */ new WeakMap(), po = /* @__PURE__ */ new WeakMap(), or = /* @__PURE__ */ new WeakMap(), vn = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), Sa = /* @__PURE__ */ new WeakSet(), Ml = function() {
  if (f(this, vn))
    return;
      ...
      (async () => {
        ...
        try {
          ...
          for (const { resolve: i, reject: o, payload: c } of e) {
            if (this.destroyed) {
              o(It("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", { operation: c.method }));
              continue;
            }
            const a = s.filter((l) => l.id === c.id)[0];
            if (a == null) {
              const l = It("missing response for request", "BAD_DATA", {
                value: s,
                info: { payload: c }
              });
...
class CA extends RA {
  constructor(t, e) {
    ...
    r == null && (r = eg.pollingInterval), A(this, kr, r);
  }
  _getSubscriber(t) {
...
function Ou(n) {
  return typeof n == "string" && (n = MA(n)), lc(n), n;
}
function HA(...n) {
  let t = 0;
  for (let r = 0; r < n.length; r++) {
...
const $A = (n, t, e) => n & t ^ ~n & e, jA = (n, t, e) => n & t ^ n & e ^ t & e;
class WA extends rg {
  constructor(t, e, r, s) {
  ...
  digestInto(t) {
    ja(this), FA(t, this), this.finished = !0;
    const { buffer: e, view: r, blockLen: s, isLE: i } = this;
    let { pos: o } = this;
    e[o++] = 128, this.buffer.subarray(o).fill(0), this.padOffset > s - o && (this.process(r, 0), o = 0);
    for (let u = o; u < s; u++)
      e[u] = 0;
    VA(r, s - 8, BigInt(this.length * 8), i), this.process(r, 0);
...
const zA = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class QA extends WA {
  ...
  process(t, e) {
    ...
    for (let u = 0; u < 64; u++) {
      const p = We(c, 6) ^ We(c, 11) ^ We(c, 25), b = h + p + $A(c, a, l) + zA[u] + Mn[u] | 0, y = (We(r, 2) ^ We(r, 13) ^ We(r, 22)) + jA(r, s, i) | 0;
...
const qA = /* @__PURE__ */ _A(() => new QA());
let sg = class extends rg {
  constructor(t, e) {
    super(), this.finished = !1, this.destroyed = !1, DA(t);
    const r = Ou(e);
...
const ig = (n, t, e) => new sg(n, t).update(e).digest();
ig.create = (n, t) => new sg(n, t);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const og = /* @__PURE__ */ BigInt(0), uc = /* @__PURE__ */ BigInt(1), KA = /* @__PURE__ */ BigInt(2);
function ls(n) {
  return n instanceof Uint8Array || n != null && typeof n == "object" && n.constructor.name === "Uint8Array";
}
function Vo(n) {
...
const JA = /* @__PURE__ */ Array.from({ length: 256 }, (n, t) => t.toString(16).padStart(2, "0"));
function us(n) {
  Vo(n);
  let t = "";
  for (let e = 0; e < n.length; e++)
...
function ku(n) {
  return Vo(n), Bu(us(Uint8Array.from(n).reverse()));
}
function ui(n, t) {
...
function n1(n, t, e) {
  return n | (e ? uc : og) << BigInt(t);
}
const Tu = (n) => (KA << BigInt(n - 1)) - uc, Fc = (n) => new Uint8Array(n), gf = (n) => Uint8Array.from(n);
function cg(n, t, e) {
  if (typeof n != "number" || n < 2)
    throw new Error("hashLen must be a number");
  if (typeof t != "number" || t < 2)
...
const s1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  numberToVarBytesBE: ZA,
  utf8ToBytes: XA,
  validateObject: $o
}, Symbol.toStringTag, { value: "Module" }));
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Vt = BigInt(0), Tt = BigInt(1), Lr = BigInt(2), i1 = BigInt(3), Gl = BigInt(4), yf = BigInt(5), mf = BigInt(8);
BigInt(9);
BigInt(16);
function Ne(n, t) {
  const e = n % t;
...
function a1(n) {
  const t = (n - Tt) / Lr;
  let e, r, s;
  for (e = n - Tt, r = 0; e % Lr === Vt; e /= Lr, r++)
    ;
  for (s = Lr; s < n && o1(s, t, n) !== n - Tt; s++)
    ;
  if (r === 1) {
    const o = (n + Tt) / Gl;
    return function(c, a) {
...
function u1(n) {
  const t = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, e = l1.reduce((r, s) => (r[s] = "function", r), t);
  return $o(n, e);
}
function h1(n, t, e) {
  if (e < Vt)
...
function d1(n, t, e = !1, r = {}) {
  if (n <= Vt)
    throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: s, nByteLength: i } = lg(n, t);
  if (i > 2048)
    throw new Error("Field lengths over 2048 bytes are not supported");
  const o = c1(n), c = Object.freeze({
    ORDER: n,
    BITS: s,
    BYTES: i,
    MASK: Tu(s),
...
function p1(n, t, e = !1) {
  const r = n.length, s = ug(t), i = hg(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error(`expected ${i}-1024 bytes of input, got ${r}`);
  const o = e ? Yr(n) : ku(n), c = Ne(o, t - Tt) + Tt;
  return e ? Su(c, s) : ui(c, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const g1 = BigInt(0), Mc = BigInt(1);
function y1(n, t) {
  const e = (s, i) => {
    const o = i.negate();
    return s ? o : i;
...
const { bytesToNumberBE: w1, hexToBytes: b1 } = s1, Wr = {
  // asn.1 DER encoding utils
  Err: class extends Error {
    constructor(n = "") {
      super(n);
  ...
  _parseInt(n) {
    ...
    if (r[0] === 0 && !(r[1] & 128))
      throw new t("Invalid signature integer: unnecessary leading zero");
    return { d: w1(r), l: n.subarray(e + 2) };
  },
  toSig(n) {
    const { Err: t } = Wr, e = typeof n == "string" ? b1(n) : n;
    Vo(e);
    let r = e.length;
    if (r < 2 || e[0] != 48)
      throw new t("Invalid signature tag");
...
}, xn = BigInt(0), ve = BigInt(1);
BigInt(2);
const wf = BigInt(3);
BigInt(4);
function A1(n) {
  const t = m1(n), { Fp: e } = t, r = t.toBytes || ((y, d, g) => {
    const w = d.toAffine();
  ...
  function a(y) {
    ...
    let v;
    try {
      v = typeof y == "bigint" ? y : Yr(Le("private key", y, g));
    } catch {
      throw new Error(`private key must be ${g} bytes, hex or bigint, not ${typeof y}`);
    }
  ...
  class u {
    ...
    multiplyUnsafe(d) {
      ...
      let { k1neg: I, k1: v, k2neg: T, k2: k } = w.splitScalar(d), x = g, N = g, B = this;
      for (; v > xn || k > xn; )
        v & ve && (x = x.add(B)), k & ve && (N = N.add(B)), B = B.double(), v >>= ve, k >>= ve;
      return I && (x = x.negate()), T && (N = N.negate()), N = new u(e.mul(N.px, w.beta), N.py, N.pz), x.add(N);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(d, g, w) {
      const I = u.BASE, v = (k, x) => x === xn || x === ve || !k.equals(I) ? k.multiplyUnsafe(x) : k.multiply(x), T = v(this, g).add(v(d, w));
      return T.is0() ? void 0 : T;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
  ...
  u.BASE = new u(t.Gx, t.Gy, e.ONE), u.ZERO = new u(e.ZERO, e.ONE, e.ZERO);
  const p = t.nBitLength, b = y1(u, t.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: t,
    ProjectivePoint: u,
    normPrivateKeyToScalar: a,
...
function v1(n) {
  const t = E1(n), { Fp: e, n: r } = t, s = e.BYTES + 1, i = 2 * e.BYTES + 1;
  function o(m) {
  ...
  const { ProjectivePoint: l, normPrivateKeyToScalar: h, weierstrassEquation: u, isWithinCurveOrder: p } = A1({
    ...t,
    toBytes(m, E, R) {
    ...
    fromBytes(m) {
      ...
      if (E === s && (R === 2 || R === 3)) {
        ...
        try {
          ...
          const rt = Z instanceof Error ? ": " + Z.message : "";
          throw new Error("Point is not on curve" + rt);
        }
        const K = (Q & ve) === ve;
        return (R & 1) === 1 !== K && (Q = e.neg(Q)), { x: H, y: Q };
      } else if (E === i && R === 4) {
  ...
  class w {
    ...
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(E) {
      const { r: R, s: M } = Wr.toSig(Le("DER", E));
      return new w(R, M);
    }
    assertValidity() {
      if (!p(this.r))
  ...
  function U(m, E, R = P) {
    ...
    function Ht(lt) {
      ...
      if (Ut === xn)
        return;
      let Be = (at.x === Et ? 0 : 2) | Number(at.y & ve), ke = Ut;
      return G && y(Ut) && (ke = d(Ut), Be ^= 1), new w(Et, ke, Be);
    }
    return { seed: At, k2sig: Ht };
  }
  ...
  function $(m, E, R = P) {
    const { seed: M, k2sig: H } = U(m, E, R), G = t;
    return cg(G.hash.outputLen, G.nByteLength, G.hmac)(M, H);
  }
  l.BASE._setWindowSize(8);
  function nt(m, E, R, M = V) {
    var H;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const dg = d1(BigInt("0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff")), N1 = dg.create(BigInt("-3")), O1 = BigInt("0x5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b"), B1 = I1({
  a: N1,
  // Equation params: a, b
  b: O1,
  Fp: dg,
  ...
  h: BigInt(1),
  lowS: !1
}, qA), bf = B1, xo = "embeddedWallet", Ru = 23294, Cu = 23295, hi = {
...
function Af(n) {
  if (typeof window < "u")
    return window[xo] = new gg(n), window[xo];
}
function Io() {
  if (typeof window < "u")
    return window[xo] || (window[xo] = new gg()), window[xo];
}
async function Xr(n = "") {
  var t, e;
  const r = await ((e = (t = Io()) == null ? void 0 : t.accountManagerContract) == null ? void 0 : e.salt());
  if (r)
    return N0(n, Lt(r), 1e5, 32, "sha256");
}
function Hc(n) {
  return [Cu, Ru].includes(n);
}
function st(n, t = "Error") {
  const e = new Error(t);
  throw e.name = Kt[n], e;
}
let Ef = class {
  ...
  async getRegisterData(t) {
    t.username || st("NO_USERNAME"), t.password || st("NO_PASSWORD");
    const e = await Xr(t.username);
    if (!e) {
      st("CANT_HASH_USERNAME");
      return;
    }
  ...
  async getProxyResponse(t, e, r) {
    r.username || st("NO_USERNAME"), r.password || st("NO_PASSWORD");
    const s = await Xr(r.username);
    s || st("CANT_HASH_USERNAME");
    const i = ib(
      ["bytes32", "bytes"],
      [xl(r.password), e]
    );
...
function R1(n) {
  ...
  const t = n.slice(32, 33)[0], e = {
    ...
    signCount: k1(n.slice(33, 37))
    //  4 bytes
  };
  if (e.flags.ED)
    throw new Error("Extension Data not supported!");
  if (e.flags.AT) {
    const r = S1(n.slice(53, 55));
    e.attestedCredentialData = {
      ...
      credentialPublicKey: T1(n.slice(55 + r).buffer)
    };
  }
  return e;
}
function C1(n) {
  const t = jf.decode(new Uint8Array(n).buffer).authData;
  return R1(t);
}
async function P1(n, t, e) {
...
async function D1(n, t) {
  ...
  }), r = e.response, s = qr.verifySchema(r.signature, L1);
  if (!s.verified)
  ...
  return {
    credentialIdHashed: Ot(new Uint8Array(e.rawId)),
    challenge: t,
    resp: {
      authenticatorData: new Uint8Array(r.authenticatorData),
      clientDataTokens: U1(a),
      sigR: o,
      sigS: c
    }
  };
...
let vf = class {
  ...
  async getProxyResponse(t, e, r) {
    r.username || st("NO_USERNAME");
    const s = r.hashedUsername || await Xr(r.username);
    s || st("CANT_HASH_USERNAME");
    const i = await t.personalization(), o = await t.credentialIdsByUsername(s), c = await D1(
      // binary credential ids
      o.map((a) => Lt(a)),
      // challenge
      Lt(hr(i + hr(e).slice(2)))
    );
...
class F1 extends Wf {
  constructor() {
    super(new Error(pg[Kt.OASIS_WALLET_NOT_INITIALIZED]), {
      code: 4900,
...
let gg = class {
  ...
  constructor(t) {
    ...
    if (this.sapphireProvider = I0.wrap(e), this.accountManagerContract = new cs(
      t?.accountManagerAddress || "0xF35C3eB93c6D3764A7D5efC6e9DEB614779437b1",
      !(t != null && t.onGetSignature) && !(t != null && t.onGetApillonSessionToken) ? UA : ng,
    ...
    this.events = O0(), this.isTest = !!(t != null && t.test), this.onGetSignature = t?.onGetSignature, this.onGetApillonSessionToken = t?.onGetApillonSessionToken;
    try {
   ...
   */
  async userExists(t) {
    return this.sapphireProvider || st("SAPPHIRE_PROVIDER_NOT_INITIALIZED"), this.accountManagerContract || st("ACCOUNT_MANAGER_CONTRACT_NOT_INITIALIZED"), await this.accountManagerContract.userExists(
      await Xr(t)
    ) || !1;
  }
  /**
   ...
   */
  async register(t, e) {
    this.sapphireProvider || st("SAPPHIRE_PROVIDER_NOT_INITIALIZED"), this.accountManagerContract || st("ACCOUNT_MANAGER_CONTRACT_NOT_INITIALIZED");
    let r;
    ...
    if (this.onGetSignature || this.onGetApillonSessionToken) {
      ...
      l.signature || st("CANT_GET_SIGNATURE"), c = await this.accountManagerContract.generateGaslessTx(
        s,
        o,
  ...
  async authenticate(t, e) {
    this.sapphireProvider || st("SAPPHIRE_PROVIDER_NOT_INITIALIZED"), this.accountManagerContract || st("ACCOUNT_MANAGER_CONTRACT_NOT_INITIALIZED"), e.username || st("NO_USERNAME");
    ...
    c || st("NO_LOGIN_PROXY_DATA");
    const [[a, l, h]] = i.decodeFunctionResult("sign", c).toArray(), u = yp(r, {
      r: a,
      s: l,
      v: h
  ...
  async getAccountAddress(t) {
    if (this.sapphireProvider || st("SAPPHIRE_PROVIDER_NOT_INITIALIZED"), this.accountManagerContract || st("ACCOUNT_MANAGER_CONTRACT_NOT_INITIALIZED"), !t) {
  ...
  async getApillonSignature(t) {
    if (!this.onGetApillonSessionToken)
      return st("NO_APILLON_SESSION_TOKEN_CALLBACK"), { signature: "", gasLimit: 0, timestamp: 0 };
    try {
      const e = await this.onGetApillonSessionToken();
      e || st("INVALID_APILLON_SESSION_TOKEN");
      const { data: r } = await (await fetch(
        `${M1.VITE_APILLON_BASE_URL ?? "https://api.apillon.io"}/embedded-wallet/signature`,
        {
          method: "POST",
  ...
  // #region Transactions
  async signMessage(t) {
    this.sapphireProvider || st("SAPPHIRE_PROVIDER_NOT_INITIALIZED");
    const e = new Ss(na);
    let r = t.data || "";
    const s = t.message;
    ...
    t.authData || (t.strategy === "passkey" && this.lastAccount.username ? t.authData = { username: this.lastAccount.username } : st("AUTHENTICATION_DATA_NOT_PROVIDED"));
  ...
  async signPlainTransaction(t) {
    ...
    const r = this.validateChainId(
      ((e = t?.tx) == null ? void 0 : e.chainId) && +t.tx.chainId.toString() || 0
    );
    ...
    t.authData || st("AUTHENTICATION_DATA_NOT_PROVIDED");
  ...
  async signContractWrite(t) {
    ...
    r != null && r.publicAddress || st("CANT_GET_ACCOUNT_ADDRESS");
  ...
  async getProxyForStrategy(t, e, r) {
    if (this.accountManagerContract || st("ACCOUNT_MANAGER_CONTRACT_NOT_INITIALIZED"), t === "password")
  ...
  async waitForTxReceipt(t, e) {
    !e && !this.sapphireProvider && st("SAPPHIRE_PROVIDER_NOT_INITIALIZED");
    const r = 60;
    let s = 0;
    for (; ; ) {
   ...
   */
  validateChainId(t) {
    return (t && !Hc(t) && !this.rpcUrls[t] || !t && this.defaultNetworkId && !this.rpcUrls[this.defaultNetworkId]) && st("NO_RPC_URL_CONFIGURED_FOR_SELECTED_CHAINID"), !t && this.defaultNetworkId && (t = this.defaultNetworkId), t;
  }
  /**
  ...
  getRpcProviderForChainId(t) {
    if (!t || t && Hc(+t.toString()))
      return this.sapphireProvider || (this.events.emit("disconnect", { error: new F1() }), st("SAPPHIRE_PROVIDER_NOT_INITIALIZED")), this.sapphireProvider;
    {
      const e = this.rpcProviders[t] || new Uc(this.rpcUrls[t]);
      return this.rpcProviders[t] = e, e || st("CROSS_CHAIN_PROVIDER_NOT_INITIALIZED"), e;
    }
  }
  // #endregion
};
...
function _1({
  ...
  const [s, i] = Zl(H1, yg(e || t[0].id)), [o, c] = wt(!1), [a, l] = wt();
  ae(() => {
    if (o) {
  ...
  async function h(u) {
    ...
    if (p && s.address)
      try {
        const b = await p?.getAccountBalance(s.address);
      ...
      value: {
        ...
        handleError: (u) => {
          ...
          if (u) {
            console.error(u);
            let b = "";
            u != null && u.name && (b = pg[u.name]), !b && u != null && u.error && ((p = u?.error) != null && p.message ? b = u.error.message : typeof u.error == "string" && (b = u.error)), !b && u != null && u.message && (b = u.message), b && i({
              type: "setValue",
...
function wg(n) {
  ...
  if (typeof n == "string" || typeof n == "number") r += n;
    ...
    var s = n.length;
    for (t = 0; t < s; t++) n[t] && (e = wg(n[t])) && (r && (r += " "), r += e);
  } else for (e in n) n[e] && (r && (r += " "), r += e);
  return r;
}
function Pu() {
  for (var n, t, e = 0, r = "", s = arguments.length; e < s; e++) (n = arguments[e]) && (t = wg(n)) && (r && (r += " "), r += t);
  return r;
}
function G1({
  size: n = 36,
...
const V1 = "160px", $1 = "40px", j1 = "px-4 py-2.5", jt = b0(
  ({
    blank: n = !1,
    self: t = !1,
    variant: e = "primary",
...
function No({
  ...
  const { state: r, handleError: s } = ge();
...
function W1({
  ...
  const { dispatch: o, defaultNetworkId: c, handleError: a } = ge(), [l, h] = wt(""), [u, p] = wt(!1), [b, y] = wt(!1), [d, g] = wt(!1);
  async function w(T) {
    ...
    p(!0), a();
    try {
      if (await k?.userExists(l)) {
        const x = await k?.authenticate("passkey", { username: l });
        x && v({
          username: l,
        ...
        const x = await i();
        x || st("INVALID_APILLON_SESSION_TOKEN"), await fetch(
  ...
  async function I() {
    p(!0), a();
    try {
      const T = Io(), k = await T?.register("passkey", { username: l });
  ...
  async function v({
    ...
    const N = Io(), B = await N?.getAccountBalance(k) || "0";
    o({
      type: "setState",
      payload: {
        address: k,
        ...
        onConfirm: async (T) => {
          ...
          try {
            if (s)
              ...
              const k = await i();
              k || st("INVALID_APILLON_SESSION_TOKEN");
...
function Q1() {
  const { state: n, dispatch: t, networks: e, wallet: r, setScreen: s } = ge();
  if (!Array.isArray(e) || !e.length)
    return /* @__PURE__ */ L(on, {});
  function i(o) {
    t({ type: "setValue", payload: { key: "networkId", value: o } }), r?.setDefaultNetworkId(o), s("main");
  }
...
const Ag = Jl(void 0);
function J1({ children: n }) {
  const [t, e] = Zl(K1, q1()), [r, s] = wt(!1), {
    state: { address: i },
    reloadUserBalance: o
  } = ge();
  ae(() => {
  ...
  return /* @__PURE__ */ L(Ag.Provider, { value: { state: t, dispatch: e, checkTransaction: c }, children: n });
}
function Eg() {
  const n = Yl(Ag);
  if (n === void 0)
...
function Z1() {
  ...
  return !n || !t.txs[n] ? /* @__PURE__ */ L(on, {}) : /* @__PURE__ */ L("div", { children: /* @__PURE__ */ L("div", { className: "flex flex-col gap-1 max-h-[134px] overflow-auto pr-2", children: Object.values(t.txs[n]).sort((e, r) => (r.createdAt || 0) - (e.createdAt || 0)).map((e) => /* @__PURE__ */ L(Y1, { tx: e }, e.hash)) }) });
}
function Y1({ tx: n }) {
...
function eE({ children: n }) {
  const [t, e] = Zl(tE, X1()), [r, s] = wt(!1), { state: i, wallet: o } = ge();
  ae(() => {
    ...
    if (h)
      try {
        ...
        e({ type: "setState", payload: u }), Array.isArray((l = (a = u?.list) == null ? void 0 : a[i.address]) == null ? void 0 : l[i.networkId]) && u.list[i.address][i.networkId].forEach(
          async (p) => {
            if (o) {
...
function nE() {
  const { state: n, networksById: t, setScreen: e, wallet: r, handleError: s } = ge(), { state: i } = xg(), [o, c] = wt(""), [a, l] = wt(""), [h, u] = wt(!1), p = Ta(
    () => {
      var y;
      return {
        address: "",
        name: `${(y = t?.[n.networkId]) == null ? void 0 : y.name} ETH`,
        symbol: "ETH",
        decimals: 18,
        balance: n.balance
      };
  ...
  return n.walletScreen === "selectToken" ? /* @__PURE__ */ L(rE, { nativeToken: p }) : n.walletScreen === "receiveToken" ? /* @__PURE__ */ L(sE, {}) : /* @__PURE__ */ J(
    "form",
    {
      onSubmit: async (y) => {
...
function rE({ nativeToken: n }) {
  const { state: t, setScreen: e, handleError: r } = ge(), { state: s, dispatch: i, getTokenDetails: o } = xg(), [c, a] = wt(""), [l, h] = wt(!1), u = Ta(() => {
    var p;
...
function sE() {
  const { state: n } = ge(), { text: t, onCopy: e } = Uu();
...
function iE() {
  const { wallet: n, state: t, dispatch: e, networksById: r, setScreen: s } = ge(), i = Ta(() => t.walletScreen === "main" ? { key: "networks", label: "Change" } : t.walletScreen === "selectToken" ? { key: "sendToken", label: "Back" } : { key: "main", label: "Back" }, [t.walletScreen]);
  return /* @__PURE__ */ J("div", { children: [
    ...
    t.walletScreen === "networks" && /* @__PURE__ */ L("div", { children: /* @__PURE__ */ L(Q1, {}) }),
    ["sendToken", "selectToken", "receiveToken"].includes(t.walletScreen) && /* @__PURE__ */ L("div", { children: /* @__PURE__ */ L(eE, { children: /* @__PURE__ */ L(nE, {}) }) })
  ] });
}
function oE({ className: n }) {
  const { state: t } = ge(), { text: e, onCopy: r } = Uu();
  return /* @__PURE__ */ J("div", { className: n, children: [
    ...
    /* @__PURE__ */ J("p", { title: t.address, className: "text-xl", children: [
      /* @__PURE__ */ L("span", { className: "mr-2", children: bg(t.address) }),
...
function aE({
  ...
  const { networksById: c, wallet: a, dispatch: l } = ge(), [h, u] = wt(!1), p = "bg-offwhite/25 p-3 whitespace-pre-wrap break-all rounded-sm mt-2";
...
function cE({
  ...
  const { state: r, wallet: s, setScreen: i, handleError: o, reloadUserBalance: c } = ge(), { dispatch: a } = Eg(), [l, h] = wt(!1), [u, p] = wt(), [b, y] = wt(), [d, g] = wt(""), [w, I] = wt({
    title: "",
    txHash: "",
    explorerUrl: ""
  }), v = nr(), T = r.username && r.address;
  ae(() => {
    const N = (V) => {
      var $;
    ...
    return s && (s.events.on("txApprove", N), s.events.on("signatureRequest", B), s.events.on("txSubmitted", _), s.events.on("providerRequestAccounts", U), s.events.on("dataUpdated", P)), () => {
      s && (s.events.off("txApprove", N), s.events.off("signatureRequest", B), s.events.off("txSubmitted", _), s.events.off("providerRequestAccounts", U), s.events.off("dataUpdated", P));
    };
  }, [s]), ae(() => {
  ...
  return T ? u || d || b ? w.title ? x = /* @__PURE__ */ J("div", { className: "text-center", children: [
    ...
    aE,
    {
        ...
        if (v.current)
          try {
            if (o(), v.current.signature)
              ...
              const N = await s?.signPlainTransaction({
                ...v.current.plain,
                authData: { username: r.username }
              });
              if (n)
                ...
                const { signedTxData: B, chainId: _ } = N, U = await s?.broadcastTransaction(
                  B,
                  _,
                ...
                I({
                  ...
                  explorerUrl: U?.txItem.explorerUrl || "",
                  txHash: U?.txHash || ""
                });
              }
            } else if (v.current.contractWrite) {
              const N = await s?.signContractWrite({
      ...
      onDecline: () => {
        var N, B, _, U, P, V;
        k(), (B = (N = v.current) == null ? void 0 : N.contractWrite) != null && B.reject ? v.current.contractWrite.reject(new _c()) : (U = (_ = v.current) == null ? void 0 : _.plain) != null && U.reject ? v.current.plain.reject(new _c()) : (V = (P = v.current) == null ? void 0 : P.signature) != null && V.reject && v.current.signature.reject(new _c());
      }
    }
  ) : x = /* @__PURE__ */ L(iE, {}) : x = /* @__PURE__ */ L(W1, { ...e }), /* @__PURE__ */ J("div", { children: [
    /* @__PURE__ */ L(lE, { isOpen: l, setIsOpen: h, children: x }),
    /* @__PURE__ */ L(
      "button",
      {
...
function lE({
  ...
  return /* @__PURE__ */ L(on, { children: /* @__PURE__ */ L(E0, { show: t, children: /* @__PURE__ */ J(
    v0,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ L(
          Ku,
          {
            ...
            children: /* @__PURE__ */ L("div", { className: "fixed inset-0 w-screen overflow-y-auto p-4", children: /* @__PURE__ */ L("div", { className: "flex items-center justify-center min-h-full", children: /* @__PURE__ */ J(x0, { className: "relative max-w-lg w-full min-h-[600px] bg-dark p-8 sm:py-16 sm:px-12 border border-brightdark text-offwhite", children: [
...
function uE(n) {
  return /* @__PURE__ */ L(_1, { ...n, children: /* @__PURE__ */ L(J1, { children: /* @__PURE__ */ L(cE, { ...n }) }) });
}
function hE(n, t) {
  ...
  e = document.querySelector(n), e || (e = document.createElement("div"), e.id = "embedded-wallet", e.setAttribute("style", "display: none;"), document.body.appendChild(e)), Ii.createRoot(e).render(
    /* @__PURE__ */ L(w0.StrictMode, { children: /* @__PURE__ */ L(uE, { ...t }) })
  );
}
function Ax({ className: n, ...t }) {
  const e = nr(!1);
  return ae(() => {
    setTimeout(() => {
      e.current || (e.current = !0, hE("#embedded-wallet-activator-react", t));
    }, 5);
  }, []), /* @__PURE__ */ L("div", { id: "embedded-wallet-activator-react", className: n });
}
const fE = "6.13.1";
function If(n, t, e) {
  for (let r in t) {
...
function dE(n, t, e) {
  let r = n;
  {
    ...
    i.push(`code=${t}`), i.push(`version=${fE}`), i.length && (n += " (" + i.join(", ") + ")");
  }
  let s;
  switch (t) {
    case "INVALID_ARGUMENT":
...
function pE(n, t, e) {
  ...
  Ge(!1, "invalid BytesLike value", t || "value", n);
}
function Du(n, t) {
  return pE(n, t);
}
...
function yE(n, t) {
  switch (typeof n) {
    case "bigint":
      return n;
    case "number":
      return Ge(Number.isInteger(n), "underflow", t || "value", n), Ge(n >= -Ws && n <= Ws, "overflow", t || "value", n), BigInt(n);
    case "string":
      try {
        if (n === "")
          throw new Error("empty string");
        ...
        Ge(!1, `invalid BigNumberish string: ${e.message}`, t || "value", n);
      }
  }
  Ge(!1, "invalid BigNumberish value", t || "value", n);
}
function mE(n, t) {
  const e = yE(n, t);
  return Lu(e >= gE, "unsigned value cannot be negative", "NUMERIC_FAULT", {
    fault: "overflow",
    operation: "getUint",
    value: n
  }), e;
...
function Ng(n, t) {
  switch (typeof n) {
    case "bigint":
      return Ge(n >= -Ws && n <= Ws, "overflow", t || "value", n), Number(n);
    case "number":
      return Ge(Number.isInteger(n), "underflow", t || "value", n), Ge(n >= -Ws && n <= Ws, "overflow", t || "value", n), n;
    case "string":
      try {
        if (n === "")
          throw new Error("empty string");
        return Ng(BigInt(n), t);
      } catch (e) {
        Ge(!1, `invalid numeric string: ${e.message}`, t || "value", n);
      }
  }
  Ge(!1, "invalid numeric value", t || "value", n);
}
function Og(n, t) {
  let e = mE(n, "value").toString(16);
  {
    const r = Ng(t, "width");
...
for (; Gc.length < 80; )
  Gc += Gc;
const Of = globalThis || void 0 || self;
function Wa(n) {
  if (!Number.isSafeInteger(n) || n < 0)
    throw new Error(`Wrong positive integer: ${n}`);
}
...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const kg = (n) => n instanceof Uint8Array, bE = (n) => new Uint32Array(n.buffer, n.byteOffset, Math.floor(n.byteLength / 4)), $c = (n) => new DataView(n.buffer, n.byteOffset, n.byteLength), ze = (n, t) => n << 32 - t | n >>> t, AE = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!AE)
  throw new Error("Non little-endian hardware is not supported");
function EE(n) {
  if (typeof n != "string")
...
function hc(n) {
  if (typeof n == "string" && (n = EE(n)), !kg(n))
    throw new Error(`expected Uint8Array, got ${typeof n}`);
  return n;
}
function vE(...n) {
...
let Sg = class extends Mu {
  constructor(n, t) {
    super(), this.finished = !1, this.destroyed = !1, wE(n);
    const e = hc(t);
    if (this.iHash = n.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
...
const Tg = (n, t, e) => new Sg(n, t).update(e).digest();
Tg.create = (n, t) => new Sg(n, t);
function IE(n, t, e, r) {
  if (typeof n.setBigUint64 == "function")
    return n.setBigUint64(t, e, r);
  const s = BigInt(32), i = BigInt(4294967295), o = Number(e >> s & i), c = Number(e & i), a = r ? 4 : 0, l = r ? 0 : 4;
...
class Rg extends Mu {
  ...
  digestInto(t) {
    fi(this), Bg(t, this), this.finished = !0;
    const { buffer: e, view: r, blockLen: s, isLE: i } = this;
    let { pos: o } = this;
    e[o++] = 128, this.buffer.subarray(o).fill(0), this.padOffset > s - o && (this.process(r, 0), o = 0);
    for (let u = o; u < s; u++)
...
const NE = (n, t, e) => n & t ^ ~n & e, OE = (n, t, e) => n & t ^ n & e ^ t & e, BE = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
let kE = class extends Rg {
  ...
  process(n, t) {
    ...
    let { A: e, B: r, C: s, D: i, E: o, F: c, G: a, H: l } = this;
    for (let h = 0; h < 64; h++) {
      const u = ze(o, 6) ^ ze(o, 11) ^ ze(o, 25), p = l + u + NE(o, c, a) + BE[h] + _n[h] | 0, b = (ze(e, 2) ^ ze(e, 13) ^ ze(e, 22)) + OE(e, r, s) | 0;
      l = a, a = c, c = o, o = i + p | 0, i = s, s = r, r = e, e = p + b | 0;
    }
    e = e + this.A | 0, r = r + this.B | 0, s = s + this.C | 0, i = i + this.D | 0, o = o + this.E | 0, c = c + this.F | 0, a = a + this.G | 0, l = l + this.H | 0, this.set(e, r, s, i, o, c, a, l);
  }
...
const Cg = /* @__PURE__ */ Hu(() => new kE()), ra = /* @__PURE__ */ BigInt(2 ** 32 - 1), $l = /* @__PURE__ */ BigInt(32);
function Pg(n, t = !1) {
...
function Ug(n, t = !1) {
  let e = new Uint32Array(n.length), r = new Uint32Array(n.length);
  for (let s = 0; s < n.length; s++) {
    const { h: i, l: o } = Pg(n[s], t);
    [e[s], r[s]] = [i, o];
  }
  return [e, r];
}
const SE = (n, t) => BigInt(n >>> 0) << $l | BigInt(t >>> 0), TE = (n, t, e) => n >>> e, RE = (n, t, e) => n << 32 - e | t >>> e, CE = (n, t, e) => n >>> e | t << 32 - e, PE = (n, t, e) => n << 32 - e | t >>> e, UE = (n, t, e) => n << 64 - e | t >>> e - 32, LE = (n, t, e) => n >>> e - 32 | t << 64 - e, DE = (n, t) => t, FE = (n, t) => n, Lg = (n, t, e) => n << e | t >>> 32 - e, Dg = (n, t, e) => t << e | n >>> 32 - e, Fg = (n, t, e) => t << e - 32 | n >>> 64 - e, Mg = (n, t, e) => n << e - 32 | t >>> 64 - e;
function ME(n, t, e, r) {
  const s = (t >>> 0) + (r >>> 0);
  return { h: n + e + (s / 2 ** 32 | 0) | 0, l: s | 0 };
}
const HE = (n, t, e) => (n >>> 0) + (t >>> 0) + (e >>> 0), _E = (n, t, e, r) => t + e + r + (n / 2 ** 32 | 0) | 0, GE = (n, t, e, r) => (n >>> 0) + (t >>> 0) + (e >>> 0) + (r >>> 0), VE = (n, t, e, r, s) => t + e + r + s + (n / 2 ** 32 | 0) | 0, $E = (n, t, e, r, s) => (n >>> 0) + (t >>> 0) + (e >>> 0) + (r >>> 0) + (s >>> 0), jE = (n, t, e, r, s, i) => t + e + r + s + i + (n / 2 ** 32 | 0) | 0, X = {
  fromBig: Pg,
  split: Ug,
  toBig: SE,
  shrSH: TE,
...
class QE extends Rg {
  ...
  process(t, e) {
    ...
    for (let v = 16; v < 80; v++) {
      const T = Gn[v - 15] | 0, k = Vn[v - 15] | 0, x = X.rotrSH(T, k, 1) ^ X.rotrSH(T, k, 8) ^ X.shrSH(T, k, 7), N = X.rotrSL(T, k, 1) ^ X.rotrSL(T, k, 8) ^ X.shrSL(T, k, 7), B = Gn[v - 2] | 0, _ = Vn[v - 2] | 0, U = X.rotrSH(B, _, 19) ^ X.rotrBH(B, _, 61) ^ X.shrSH(B, _, 6), P = X.rotrSL(B, _, 19) ^ X.rotrBL(B, _, 61) ^ X.shrSL(B, _, 6), V = X.add4L(N, P, Vn[v - 7], Vn[v - 16]), $ = X.add4H(V, x, U, Gn[v - 7], Gn[v - 16]);
      Gn[v] = $ | 0, Vn[v] = V | 0;
    }
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: a, Dh: l, Dl: h, Eh: u, El: p, Fh: b, Fl: y, Gh: d, Gl: g, Hh: w, Hl: I } = this;
    for (let v = 0; v < 80; v++) {
      const T = X.rotrSH(u, p, 14) ^ X.rotrSH(u, p, 18) ^ X.rotrBH(u, p, 41), k = X.rotrSL(u, p, 14) ^ X.rotrSL(u, p, 18) ^ X.rotrBL(u, p, 41), x = u & b ^ ~u & d, N = p & y ^ ~p & g, B = X.add5L(I, k, N, zE[v], Vn[v]), _ = X.add5H(B, w, T, x, WE[v], Gn[v]), U = B | 0, P = X.rotrSH(r, s, 28) ^ X.rotrBH(r, s, 34) ^ X.rotrBH(r, s, 39), V = X.rotrSL(r, s, 28) ^ X.rotrBL(r, s, 34) ^ X.rotrBL(r, s, 39), $ = r & i ^ r & c ^ i & c, nt = s & o ^ s & a ^ o & a;
      w = d | 0, I = g | 0, d = b | 0, g = y | 0, b = u | 0, y = p | 0, { h: u, l: p } = X.add(l | 0, h | 0, _ | 0, U | 0), l = c | 0, h = a | 0, c = i | 0, a = o | 0, i = r | 0, o = s | 0;
      const m = X.add3L(U, V, nt);
...
function JE(n) {
  ...
  Ge(!1, "invalid hashing algorithm name", "algorithm", n);
}
const [Hg, _g, Gg] = [[], [], []], ZE = /* @__PURE__ */ BigInt(0), xi = /* @__PURE__ */ BigInt(1), YE = /* @__PURE__ */ BigInt(2), XE = /* @__PURE__ */ BigInt(7), t2 = /* @__PURE__ */ BigInt(256), e2 = /* @__PURE__ */ BigInt(113);
for (let n = 0, t = xi, e = 1, r = 0; n < 24; n++) {
  [e, r] = [r, (2 * e + 3 * r) % 5], Hg.push(2 * (5 * r + e)), _g.push((n + 1) * (n + 2) / 2 % 64);
  let s = ZE;
  for (let i = 0; i < 7; i++)
    t = (t << xi ^ (t >> XE) * e2) % t2, t & YE && (s ^= xi << (xi << /* @__PURE__ */ BigInt(i)) - xi);
  Gg.push(s);
}
const [n2, r2] = /* @__PURE__ */ Ug(Gg, !0), kf = (n, t, e) => e > 32 ? Fg(n, t, e) : Lg(n, t, e), Sf = (n, t, e) => e > 32 ? Mg(n, t, e) : Dg(n, t, e);
function s2(n, t = 24) {
  const e = new Uint32Array(10);
  for (let r = 24 - t; r < 24; r++) {
    for (let o = 0; o < 10; o++)
    ...
    let s = n[2], i = n[3];
    for (let o = 0; o < 24; o++) {
      const c = _g[o], a = kf(s, i, c), l = Sf(s, i, c), h = Hg[o];
      s = n[h], i = n[h + 1], n[h] = a, n[h + 1] = l;
    }
    for (let o = 0; o < 50; o += 10) {
      for (let c = 0; c < 10; c++)
...
let i2 = class Vg extends Mu {
  ...
  keccak() {
    s2(this.state32, this.rounds), this.posOut = 0, this.pos = 0;
  }
  update(t) {
    fi(this);
    const { blockLen: e, state: r } = this;
  ...
  _cloneInto(t) {
    const { blockLen: e, suffix: r, outputLen: s, rounds: i, enableXOF: o } = this;
    return t || (t = new Vg(e, r, s, o, i)), t.state32.set(this.state32), t.pos = this.pos, t.posOut = this.posOut, t.finished = this.finished, t.rounds = i, t.suffix = r, t.outputLen = s, t.enableXOF = o, t.destroyed = this.destroyed, t;
  }
};
const o2 = (n, t, e) => Hu(() => new i2(t, n, e)), a2 = /* @__PURE__ */ o2(1, 136, 256 / 8);
let $g = !1;
const jg = function(n) {
  return a2(n);
};
...
Object.freeze(jo);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Kg = BigInt(0), dc = BigInt(1), c2 = BigInt(2), pc = (n) => n instanceof Uint8Array, l2 = /* @__PURE__ */ Array.from({ length: 256 }, (n, t) => t.toString(16).padStart(2, "0"));
function di(n) {
  if (!pc(n))
    throw new Error("Uint8Array expected");
  let t = "";
...
const g2 = (n, t, e) => n | (e ? dc : Kg) << BigInt(t), $u = (n) => (c2 << BigInt(n - 1)) - dc, jc = (n) => new Uint8Array(n), Tf = (n) => Uint8Array.from(n);
function Zg(n, t, e) {
  if (typeof n != "number" || n < 2)
    throw new Error("hashLen must be a number");
  if (typeof t != "number" || t < 2)
...
const m2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  numberToBytesBE: gi,
  numberToBytesLE: Vu,
  numberToHexUnpadded: Jg,
  numberToVarBytesBE: u2,
  utf8ToBytes: f2,
  validateObject: Wo
}, Symbol.toStringTag, { value: "Module" }));
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Mt = BigInt(0), Rt = BigInt(1), Dr = BigInt(2), w2 = BigInt(3), jl = BigInt(4), Rf = BigInt(5), Cf = BigInt(8);
BigInt(9);
BigInt(16);
function oe(n, t) {
  const e = n % t;
...
function A2(n) {
  const t = (n - Rt) / Dr;
  let e, r, s;
  for (e = n - Rt, r = 0; e % Dr === Mt; e /= Dr, r++)
    ;
  for (s = Dr; s < n && b2(s, t, n) !== n - Rt; s++)
    ;
  if (r === 1) {
    const o = (n + Rt) / jl;
    return function(c, a) {
  ...
  return function(o, c) {
    ...
    for (; !o.eql(u, o.ONE); ) {
      ...
      for (let y = o.sqr(u); p < a && !o.eql(y, o.ONE); p++)
        y = o.sqr(y);
      const b = o.pow(l, Rt << BigInt(a - p - 1));
      l = o.sqr(b), h = o.mul(h, b), u = o.mul(u, l), a = p;
    }
    return h;
  };
...
function x2(n) {
  const t = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, e = v2.reduce((r, s) => (r[s] = "function", r), t);
  return Wo(n, e);
}
function I2(n, t, e) {
  if (e < Mt)
  ...
  let r = n.ONE, s = t;
  for (; e > Mt; )
    e & Rt && (r = n.mul(r, s)), s = n.sqr(s), e >>= Rt;
  return r;
}
function N2(n, t) {
  const e = new Array(t.length), r = t.reduce((i, o, c) => n.is0(o) ? i : (e[c] = i, n.mul(i, o)), n.ONE), s = n.inv(r);
...
function O2(n, t, e = !1, r = {}) {
  if (n <= Mt)
    throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: s, nByteLength: i } = Yg(n, t);
  if (i > 2048)
    throw new Error("Field lengths over 2048 bytes are not supported");
  const o = E2(n), c = Object.freeze({
    ORDER: n,
    BITS: s,
    BYTES: i,
    MASK: $u(s),
...
function B2(n, t, e = !1) {
  const r = n.length, s = Xg(t), i = t0(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error(`expected ${i}-1024 bytes of input, got ${r}`);
  const o = e ? ts(n) : Gu(n), c = oe(o, t - Rt) + Rt;
  return e ? Vu(c, s) : gi(c, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const k2 = BigInt(0), Wc = BigInt(1);
function S2(n, t) {
  const e = (s, i) => {
    const o = i.negate();
    return s ? o : i;
...
const { bytesToNumberBE: R2, hexToBytes: C2 } = m2, zr = {
  // asn.1 DER encoding utils
  Err: class extends Error {
    constructor(n = "") {
      super(n);
  ...
  _parseInt(n) {
    ...
    if (r[0] === 0 && !(r[1] & 128))
      throw new t("Invalid signature integer: unnecessary leading zero");
    return { d: R2(r), l: n.subarray(e + 2) };
  },
  toSig(n) {
    const { Err: t } = zr, e = typeof n == "string" ? C2(n) : n;
    if (!(e instanceof Uint8Array))
      throw new Error("ui8a expected");
    let r = e.length;
    if (r < 2 || e[0] != 48)
...
}, In = BigInt(0), xe = BigInt(1);
BigInt(2);
const Pf = BigInt(3);
BigInt(4);
function P2(n) {
  const t = T2(n), { Fp: e } = t, r = t.toBytes || ((y, d, g) => {
    const w = d.toAffine();
  ...
  function a(y) {
    ...
    let v;
    try {
      v = typeof y == "bigint" ? y : ts(De("private key", y, g));
    } catch {
      throw new Error(`private key must be ${g} bytes, hex or bigint, not ${typeof y}`);
    }
  ...
  class u {
    ...
    multiplyUnsafe(d) {
      ...
      let { k1neg: I, k1: v, k2neg: T, k2: k } = w.splitScalar(d), x = g, N = g, B = this;
      for (; v > In || k > In; )
        v & xe && (x = x.add(B)), k & xe && (N = N.add(B)), B = B.double(), v >>= xe, k >>= xe;
      return I && (x = x.negate()), T && (N = N.negate()), N = new u(e.mul(N.px, w.beta), N.py, N.pz), x.add(N);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(d, g, w) {
      const I = u.BASE, v = (k, x) => x === In || x === xe || !k.equals(I) ? k.multiplyUnsafe(x) : k.multiply(x), T = v(this, g).add(v(d, w));
      return T.is0() ? void 0 : T;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
  ...
  u.BASE = new u(t.Gx, t.Gy, e.ONE), u.ZERO = new u(e.ZERO, e.ONE, e.ZERO);
  const p = t.nBitLength, b = S2(u, t.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: t,
    ProjectivePoint: u,
    normPrivateKeyToScalar: a,
...
function L2(n) {
  const t = U2(n), { Fp: e, n: r } = t, s = e.BYTES + 1, i = 2 * e.BYTES + 1;
  function o(m) {
  ...
  const { ProjectivePoint: l, normPrivateKeyToScalar: h, weierstrassEquation: u, isWithinCurveOrder: p } = P2({
    ...t,
    toBytes(m, E, R) {
  ...
  class w {
    ...
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(E) {
      const { r: R, s: M } = zr.toSig(De("DER", E));
      return new w(R, M);
    }
    assertValidity() {
      if (!p(this.r))
  ...
  function U(m, E, R = P) {
    ...
    function Ht(lt) {
      ...
      if (Ut === In)
        return;
      let Be = (at.x === Et ? 0 : 2) | Number(at.y & xe), ke = Ut;
      return G && y(Ut) && (ke = d(Ut), Be ^= 1), new w(Et, ke, Be);
    }
    return { seed: At, k2sig: Ht };
  }
  ...
  function $(m, E, R = P) {
    const { seed: M, k2sig: H } = U(m, E, R), G = t;
    return Zg(G.hash.outputLen, G.nByteLength, G.hmac)(M, H);
  }
  l.BASE._setWindowSize(8);
  function nt(m, E, R, M = V) {
    const H = m;
    ...
    if (G && K.hasHighS())
      return !1;
    Q && (E = t.hash(E));
    const { r: rt, s: ht } = K, At = N(E), ot = a(ht), Ht = c(At * ot), lt = c(rt * ot), yt = l.BASE.multiplyAndAddUnsafe(Z, Ht, lt)?.toAffine();
    return yt ? c(yt.x) === rt : !1;
  }
  return {
    CURVE: t,
    getPublicKey: v,
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const n0 = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Uf = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), M2 = BigInt(1), zl = BigInt(2), Lf = (n, t) => (n + t / zl) / t;
function H2(n) {
  const t = n0, e = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), a = BigInt(88), l = n * n * n % t, h = l * l * n % t, u = me(h, e, t) * h % t, p = me(u, e, t) * h % t, b = me(p, zl, t) * l % t, y = me(b, s, t) * b % t, d = me(y, i, t) * y % t, g = me(d, c, t) * d % t, w = me(g, a, t) * g % t, I = me(w, c, t) * d % t, v = me(I, e, t) * h % t, T = me(v, o, t) * y % t, k = me(T, r, t) * l % t, x = me(k, zl, t);
  if (!Ql.eql(Ql.sqr(x), n))
    throw new Error("Cannot find square root");
  return x;
}
const Ql = O2(n0, void 0, void 0, { sqrt: H2 }), _2 = F2({
  a: BigInt(0),
  b: BigInt(7),
  Fp: Ql,
  n: Uf,
  ...
  endo: {
    beta: BigInt("0x7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee"),
    splitScalar: (n) => {
      const t = Uf, e = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), r = -M2 * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), s = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), i = e, o = BigInt("0x100000000000000000000000000000000"), c = Lf(i * n, t), a = Lf(-r * n, t);
...
const W2 = "external public payable override";
zo(W2.split(" "));
const r0 = "constant external internal payable private public pure view override";
zo(r0.split(" "));
const s0 = "constructor error event fallback function receive struct";
zo(s0.split(" "));
const i0 = "calldata memory storage payable indexed";
zo(i0.split(" "));
const z2 = "tuple returns", Q2 = [s0, i0, z2, r0].join(" ");
zo(Q2.split(" "));
...
function ju(n) {
  return typeof n == "string" && (n = Y2(n)), gc(n), n;
}
function X2(...n) {
  let t = 0;
  for (let r = 0; r < n.length; r++) {
...
const rv = (n, t, e) => n & t ^ ~n & e, sv = (n, t, e) => n & t ^ n & e ^ t & e;
class iv extends o0 {
  constructor(t, e, r, s) {
  ...
  digestInto(t) {
    za(this), Z2(t, this), this.finished = !0;
    const { buffer: e, view: r, blockLen: s, isLE: i } = this;
    let { pos: o } = this;
    e[o++] = 128, this.buffer.subarray(o).fill(0), this.padOffset > s - o && (this.process(r, 0), o = 0);
    for (let u = o; u < s; u++)
      e[u] = 0;
    nv(r, s - 8, BigInt(this.length * 8), i), this.process(r, 0);
...
const ov = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class av extends iv {
  ...
  process(t, e) {
    ...
    let { A: r, B: s, C: i, D: o, E: c, F: a, G: l, H: h } = this;
    for (let u = 0; u < 64; u++) {
      const p = Qe(c, 6) ^ Qe(c, 11) ^ Qe(c, 25), b = h + p + rv(c, a, l) + ov[u] + jn[u] | 0, y = (Qe(r, 2) ^ Qe(r, 13) ^ Qe(r, 22)) + sv(r, s, i) | 0;
      h = l, l = a, a = c, c = o + b | 0, o = i, i = s, s = r, r = b + y | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, i = i + this.C | 0, o = o + this.D | 0, c = c + this.E | 0, a = a + this.F | 0, l = l + this.G | 0, h = h + this.H | 0, this.set(r, s, i, o, c, a, l, h);
  }
...
const cv = /* @__PURE__ */ tv(() => new av());
class a0 extends o0 {
  constructor(t, e) {
    super(), this.finished = !1, this.destroyed = !1, J2(t);
    const r = ju(e);
    if (this.iHash = t.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
...
const c0 = (n, t, e) => new a0(n, t).update(e).digest();
c0.create = (n, t) => new a0(n, t);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const l0 = /* @__PURE__ */ BigInt(0), yc = /* @__PURE__ */ BigInt(1), lv = /* @__PURE__ */ BigInt(2);
function hs(n) {
  return n instanceof Uint8Array || n != null && typeof n == "object" && n.constructor.name === "Uint8Array";
}
function Qo(n) {
...
const uv = /* @__PURE__ */ Array.from({ length: 256 }, (n, t) => t.toString(16).padStart(2, "0"));
function yi(n) {
  Qo(n);
  let t = "";
  for (let e = 0; e < n.length; e++)
...
function yv(n, t, e) {
  return n | (e ? yc : l0) << BigInt(t);
}
const qu = (n) => (lv << BigInt(n - 1)) - yc, qc = (n) => new Uint8Array(n), Mf = (n) => Uint8Array.from(n);
function h0(n, t, e) {
  if (typeof n != "number" || n < 2)
    throw new Error("hashLen must be a number");
  if (typeof t != "number" || t < 2)
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const $t = BigInt(0), Ct = BigInt(1), Fr = BigInt(2), bv = BigInt(3), ql = BigInt(4), Hf = BigInt(5), _f = BigInt(8);
BigInt(9);
BigInt(16);
function Oe(n, t) {
  const e = n % t;
...
function Ev(n) {
  const t = (n - Ct) / Fr;
  let e, r, s;
  for (e = n - Ct, r = 0; e % Fr === $t; e /= Fr, r++)
    ;
  for (s = Fr; s < n && Av(s, t, n) !== n - Ct; s++)
    ;
  if (r === 1) {
    const o = (n + Ct) / ql;
    return function(c, a) {
  ...
  return function(o, c) {
    ...
    for (; !o.eql(u, o.ONE); ) {
      ...
      for (let y = o.sqr(u); p < a && !o.eql(y, o.ONE); p++)
        y = o.sqr(y);
      const b = o.pow(l, Ct << BigInt(a - p - 1));
      l = o.sqr(b), h = o.mul(h, b), u = o.mul(u, l), a = p;
    }
    return h;
  };
...
function Iv(n) {
  const t = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, e = xv.reduce((r, s) => (r[s] = "function", r), t);
  return qo(n, e);
}
function Nv(n, t, e) {
  if (e < $t)
...
function Bv(n, t, e = !1, r = {}) {
  if (n <= $t)
    throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: s, nByteLength: i } = f0(n, t);
  if (i > 2048)
    throw new Error("Field lengths over 2048 bytes are not supported");
  const o = vv(n), c = Object.freeze({
    ORDER: n,
    BITS: s,
    BYTES: i,
    MASK: qu(s),
...
function kv(n, t, e = !1) {
  const r = n.length, s = d0(t), i = p0(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error(`expected ${i}-1024 bytes of input, got ${r}`);
  const o = e ? es(n) : zu(n), c = Oe(o, t - Ct) + Ct;
  return e ? Qu(c, s) : wi(c, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Sv = BigInt(0), Kc = BigInt(1);
function Tv(n, t) {
  const e = (s, i) => {
    const o = i.negate();
    return s ? o : i;
...
const { bytesToNumberBE: Cv, hexToBytes: Pv } = wv, Qr = {
  // asn.1 DER encoding utils
  Err: class extends Error {
    constructor(n = "") {
      super(n);
  ...
  _parseInt(n) {
    ...
    if (r[0] === 0 && !(r[1] & 128))
      throw new t("Invalid signature integer: unnecessary leading zero");
    return { d: Cv(r), l: n.subarray(e + 2) };
  },
  toSig(n) {
    const { Err: t } = Qr, e = typeof n == "string" ? Pv(n) : n;
    Qo(e);
    let r = e.length;
    if (r < 2 || e[0] != 48)
      throw new t("Invalid signature tag");
...
}, Nn = BigInt(0), Ie = BigInt(1);
BigInt(2);
const Gf = BigInt(3);
BigInt(4);
function Uv(n) {
  const t = Rv(n), { Fp: e } = t, r = t.toBytes || ((y, d, g) => {
    const w = d.toAffine();
  ...
  function a(y) {
    ...
    let v;
    try {
      v = typeof y == "bigint" ? y : es(Fe("private key", y, g));
    } catch {
      throw new Error(`private key must be ${g} bytes, hex or bigint, not ${typeof y}`);
    }
    return w && (v = Oe(v, I)), c(v), v;
  ...
  class u {
     ...
     */
    static fromHex(d) {
      const g = u.fromAffine(s(Fe("pointHex", d)));
      return g.assertValidity(), g;
    }
    // Multiplies generator point by privateKey.
    static fromPrivateKey(d) {
    ...
    multiplyUnsafe(d) {
      ...
      let { k1neg: I, k1: v, k2neg: T, k2: k } = w.splitScalar(d), x = g, N = g, B = this;
      for (; v > Nn || k > Nn; )
        v & Ie && (x = x.add(B)), k & Ie && (N = N.add(B)), B = B.double(), v >>= Ie, k >>= Ie;
      return I && (x = x.negate()), T && (N = N.negate()), N = new u(e.mul(N.px, w.beta), N.py, N.pz), x.add(N);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(d, g, w) {
      const I = u.BASE, v = (k, x) => x === Nn || x === Ie || !k.equals(I) ? k.multiplyUnsafe(x) : k.multiply(x), T = v(this, g).add(v(d, w));
      return T.is0() ? void 0 : T;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
    ...
    clearCofactor() {
      const { h: d, clearCofactor: g } = t;
      return d === Ie ? this : g ? g(u, this) : this.multiplyUnsafe(t.h);
    }
    toRawBytes(d = !0) {
      return this.assertValidity(), r(u, this, d);
    }
  ...
  u.BASE = new u(t.Gx, t.Gy, e.ONE), u.ZERO = new u(e.ZERO, e.ONE, e.ZERO);
  const p = t.nBitLength, b = Tv(u, t.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: t,
    ProjectivePoint: u,
    normPrivateKeyToScalar: a,
...
function Dv(n) {
  const t = Lv(n), { Fp: e, n: r } = t, s = e.BYTES + 1, i = 2 * e.BYTES + 1;
  function o(m) {
  ...
  const { ProjectivePoint: l, normPrivateKeyToScalar: h, weierstrassEquation: u, isWithinCurveOrder: p } = Uv({
    ...t,
    toBytes(m, E, R) {
  ...
  class w {
    ...
    static fromCompact(E) {
      const R = t.nByteLength;
      return E = Fe("compactSignature", E, R * 2), new w(g(E, 0, R), g(E, R, 2 * R));
    }
    // DER encoded ECDSA signature
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(E) {
      const { r: R, s: M } = Qr.toSig(Fe("DER", E));
      return new w(R, M);
    }
    assertValidity() {
      if (!p(this.r))
    ...
    recoverPublicKey(E) {
      const { r: R, s: M, recovery: H } = this, G = N(Fe("msgHash", E));
      if (H == null || ![0, 1, 2, 3].includes(H))
        throw new Error("recovery id invalid");
      const Q = H === 2 || H === 3 ? R + t.n : R;
      if (Q >= e.ORDER)
  ...
  function U(m, E, R = P) {
    ...
    const { hash: M, randomBytes: H } = t;
    let { lowS: G, prehash: Q, extraEntropy: K } = R;
    G == null && (G = !0), m = Fe("msgHash", m), Q && (m = Fe("prehashed msgHash", M(m)));
    const Z = N(m), rt = h(E), ht = [_(rt), _(Z)];
    if (K != null && K !== !1) {
      const lt = K === !0 ? H(e.BYTES) : K;
      ht.push(Fe("extraEntropy", lt));
    }
    const At = Lo(...ht), ot = Z;
    function Ht(lt) {
      const yt = x(lt);
      ...
      if (Ut === Nn)
        return;
      let Be = (at.x === Et ? 0 : 2) | Number(at.y & Ie), ke = Ut;
      return G && y(Ut) && (ke = d(Ut), Be ^= 1), new w(Et, ke, Be);
    }
    return { seed: At, k2sig: Ht };
  }
  ...
  function $(m, E, R = P) {
    const { seed: M, k2sig: H } = U(m, E, R), G = t;
    return h0(G.hash.outputLen, G.nByteLength, G.hmac)(M, H);
  }
  l.BASE._setWindowSize(8);
  function nt(m, E, R, M = V) {
    const H = m;
    if (E = Fe("msgHash", E), R = Fe("publicKey", R), "strict" in M)
      throw new Error("options.strict was renamed to lowS");
    const { lowS: G, prehash: Q } = M;
    let K, Z;
    try {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const y0 = Bv(BigInt("0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff")), Hv = y0.create(BigInt("-3")), _v = BigInt("0x5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b");
Mv({
  a: Hv,
  // Equation params: a, b
  b: _v,
...
function Vv() {
  const { wallet: n } = m0(), [t, e] = wt(""), [r, s] = wt(""), [i, o] = wt("passkey");
  ae(() => {
    const a = ({ name: l, newValue: h }) => {
      l === "username" ? e(h) : l === "address" ? s(h) : l === "authStrategy" && o(h);
    };
    return n && (e(n.lastAccount.username), s(n.lastAccount.address), o(n.lastAccount.authStrategy), n.events.on("dataUpdated", a)), () => {
      n && n.events.off("dataUpdated", a);
    };
  }, [n]);
  async function c(a = void 0) {
    return await n?.getAccountBalance(r, a);
  }
  return {
    username: t,
    address: r,
...
function Ex({
  ...
  const { wallet: s } = m0(), { username: i, authStrategy: o } = Vv();
  async function c(l, h) {
    if (!s) {
      $f("OASIS_WALLET_NOT_INITIALIZED");
      return;
    }
    return await s.contractRead({
      contractAbi: n,
      contractAddress: t,
      contractFunctionName: l,
      contractFunctionValues: h,
      chainId: e
    });
  }
  async function a(l, h, u) {
    if (!s) {
      $f("OASIS_WALLET_NOT_INITIALIZED");
      return;
    }
    return await s.signContractWrite({
      contractAbi: n,
      contractAddress: t,
      contractFunctionName: l,
      contractFunctionValues: h,
