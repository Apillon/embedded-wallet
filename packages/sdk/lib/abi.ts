export const AccountManagerAbi = [
  ...
  'function createAccount((bytes32 hashedUsername, bytes credentialId, (uint8 kty, int8 alg, uint8 crv, uint256 x, uint256 y) pubkey, bytes32 optionalPassword, (uint8 walletType, bytes32 keypairSecret, string title) wallet) args)',
  ...
  'function getAccount(bytes32 in_username) view returns (address)',
...
export const AccountAbi = [
  ...
  'function createWallet(uint8 walletType, bytes32 keypairSecret, string title) returns (address)',
  ...
  'function init(address starterOwner, uint8 walletType, bytes32 keypairSecret, string title)',
